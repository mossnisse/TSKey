(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=Object.freeze({kind:`empty`});function t(e){return e.kind===`linked`?e.targetId:null}function n(e,t){switch(e.kind){case`linked`:return t.has(e.targetId)?`linked`:`broken`;case`unresolved`:return`unresolved`;case`taxon`:return`taxon`;case`taxonDraft`:return`taxon`;case`empty`:return`empty`}}var r={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#039;`};function i(e){return e?e.replace(/[&<>"']/g,e=>r[e]):``}function a(e,t,n){let r=null,i=null;try{try{let t=new Blob([e],{type:n});r=URL.createObjectURL(t)}catch(t){console.warn(`Blob URL creation blocked by environment security constraints. Attempting standard Base64 encoding fallback.`,t);let i=new TextEncoder().encode(e),a=``,o=8192;for(let e=0;e<i.length;e+=o){let t=i.subarray(e,e+o);a+=String.fromCharCode(...t)}let s=btoa(a);r=`data:${n.toLowerCase().includes(`charset=`)?n:`${n};charset=utf-8`};base64,${s}`}i=document.createElement(`a`),i.href=r,i.download=t,i.style.display=`none`,i.style.pointerEvents=`none`,document.body.appendChild(i),i.click();let a=i,o=r;setTimeout(()=>{a&&document.body.contains(a)&&document.body.removeChild(a),o&&o.startsWith(`blob:`)&&URL.revokeObjectURL(o)},200)}catch(e){console.error(`An unhandled exception occurred during file synthesis/download processing:`,e),i&&document.body.contains(i)&&document.body.removeChild(i),r&&r.startsWith(`blob:`)&&URL.revokeObjectURL(r)}}var o=(()=>{let e=navigator.userAgentData;if(e?.platform)return e.platform.toLowerCase().includes(`mac`);let t=(navigator.platform||``).toLowerCase();if(t.includes(`mac`)||t.includes(`iphone`)||t.includes(`ipad`)||t.includes(`ipod`))return!0;let n=navigator.userAgent.toLowerCase();return n.includes(`macintosh`)||n.includes(`mac os x`)})();function s(e){if(!e||typeof e!=`object`)return!1;let t=e;switch(t.kind){case`linked`:return typeof t.targetId==`number`;case`unresolved`:return typeof t.couplet==`number`;case`taxon`:return typeof t.taxonId==`number`||typeof t.name==`string`;case`taxonDraft`:return typeof t.name==`string`;case`empty`:return!0;default:return!1}}function c(e){if(!Array.isArray(e))return!1;let t=new Set;return e.every(e=>!(e&&typeof e==`object`&&typeof e.id==`number`&&e.id>0&&typeof e.alt1==`string`&&typeof e.alt2==`string`&&s(e.branch1)&&s(e.branch2))||t.has(e.id)?!1:(t.add(e.id),!0))}function l(e){if(!Array.isArray(e))return!1;let t=new Set;return e.every(e=>!(e&&typeof e==`object`&&typeof e.id==`number`&&e.id>0&&typeof e.filename==`string`&&typeof e.caption==`string`)||t.has(e.id)?!1:(t.add(e.id),!0))}function u(e){let t=new Map;return e.forEach((e,n)=>t.set(e.id,n)),t}var d=`scientific`;function f(e){return e===`scientific`||e===`vernacular`}function p(e,t){let n=new Map;return e.forEach(e=>n.set(e.id,e)),{byId:n,nameMode:t}}function m(e,t){let n=e.scientificName.trim(),r=e.vernacularName.trim();return t===`vernacular`?r||n:n||r}function h(e,t,n){switch(e.kind){case`linked`:{let n=t.get(e.targetId);if(n!==void 0){let e=(n+1).toString();return{kind:`step`,inputValue:e,printText:e,printClass:`print-dest-strong`,isUnresolved:!1}}return{kind:`broken`,inputValue:`?`,printText:`?`,printClass:`error-text`,isUnresolved:!0}}case`unresolved`:{let t=e.couplet.toString();return{kind:`broken`,inputValue:t,printText:t,printClass:`error-text`,isUnresolved:!0}}case`taxon`:{let t=n?.byId.get(e.taxonId);return t?{kind:`taxon`,inputValue:m(t,n.nameMode),printText:m(t,n.nameMode),printClass:`print-dest-taxon`,isUnresolved:!1}:{kind:`broken`,inputValue:``,printText:`[missing taxon]`,printClass:`error-text`,isUnresolved:!0}}case`taxonDraft`:return{kind:`taxon`,inputValue:e.name,printText:e.name,printClass:`print-dest-taxon-unlinked`,isUnresolved:!1,isUnlinkedTaxon:!0};case`empty`:return{kind:`empty`,inputValue:``,printText:`...`,printClass:``,isUnresolved:!1}}}var g=`classic`;function _(e){return e===`classic`||e===`lettered`||e===`minimal`}function v(e){let n=new Map;e.forEach((e,r)=>{let i=r+1;for(let r of[e.branch1,e.branch2]){let e=t(r);if(e===null)continue;let a=n.get(e);a||n.set(e,a=new Set),a.add(i)}});let r=new Map;for(let[e,t]of n)r.set(e,[...t].sort((e,t)=>e-t));return r}function y(e,t,n){let r;switch(e){case`lettered`:r={lead1:`${t}a`,lead2:`${t}b`};break;case`minimal`:r={lead1:`${t}`,lead2:`-`};break;default:r={lead1:`${t}.`,lead2:`—`};break}return n&&n.length>0&&(r.lead1+=` (${n.join(`, `)})`),r}function b(e,t){let n=e.trim();if(n===``)return{kind:`empty`};if(/^\d+$/.test(n)){let e=parseInt(n,10),r=e-1;return r>=0&&r<t.length?{kind:`linked`,targetId:t[r].id}:{kind:`unresolved`,couplet:e}}return{kind:`taxonDraft`,name:n}}function x(e,t=`.tskey`){return`${e.toLowerCase().trim().replace(/[^a-z0-9_\-]/gi,`_`).replace(/_+/g,`_`).replace(/_$/,``)||`untitled_key`}${t}`}function S(e){return typeof e==`object`&&!!e}var C=()=>/\[figID:\s*(\d+)\s*\]/gi,w=()=>/\[fig:\s*([^\]]+?)\s*\]/gi;function T(e){let t=new Map,n=new Map,r=new Map,i=new Map;return e.forEach((e,a)=>{let o=a+1;t.set(e.id,o),n.set(o,e),i.set(e.id,e);let s=e.filename.trim().toLowerCase();s&&r.set(s,e)}),{idToDisplayNum:t,displayNumToFig:n,filenameToFig:r,idToFig:i}}function E(e,t,n){let{displayNumToFig:r,filenameToFig:i,idToDisplayNum:a}=t,o=parseInt(e,10);if(!isNaN(o)&&String(o)===e&&o>=1&&o<=n){let e=r.get(o);if(e)return{figId:e.id,displayNum:o}}let s=i.get(e.toLowerCase());if(s){let e=a.get(s.id);if(e!==void 0)return{figId:s.id,displayNum:e}}return null}function D(e,t){return new Promise((n,r)=>{e.oncomplete=()=>n(),e.onerror=()=>r(e.error),e.onabort=()=>r(Error(t))})}function O(e){return new Promise((t,n)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>n(e.error)})}var k=class{dbName=`TSKey_Workspace_DB`;projectsStoreName=`projects`;figuresStoreName=`figures`;dbPromise=null;getDB(){return this.dbPromise?this.dbPromise:(this.dbPromise=new Promise((e,t)=>{let n=indexedDB.open(this.dbName,2);n.onupgradeneeded=()=>{let e=n.result;e.objectStoreNames.contains(this.projectsStoreName)||e.createObjectStore(this.projectsStoreName,{keyPath:`title`}),e.objectStoreNames.contains(this.figuresStoreName)||e.createObjectStore(this.figuresStoreName)},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error),n.onblocked=()=>{alert(`⚠️ TSKey could not open its database because another tab still has an older version open. Please close other TSKey tabs and reload.`),t(Error(`IndexedDB open blocked by another open connection.`))}}),this.dbPromise.catch(()=>{this.dbPromise=null}),this.dbPromise)}getFigureKey(e,t){return`${e}::${t}`}parseFigureId(e){return parseInt(e.substring(e.lastIndexOf(`::`)+2),10)}getProjectKeyRange(e){let t=`${e}::`,n=t.substring(0,t.length-1)+String.fromCharCode(t.charCodeAt(t.length-1)+1);return IDBKeyRange.bound(t,n,!1,!0)}async getProjectList(){return(await O((await this.getDB()).transaction(this.projectsStoreName,`readonly`).objectStore(this.projectsStoreName).getAll())).map(e=>({name:e.title,lastModified:e.lastModified})).sort((e,t)=>t.lastModified-e.lastModified)}async saveProject(e,t,n){let r=(await this.getDB()).transaction(this.projectsStoreName,`readwrite`),i={title:e,projectUid:t,schemaVersion:2,dichotomousKey:n.dichotomousKey,figures:n.figures,taxa:n.taxa,lastModified:Date.now()};return r.objectStore(this.projectsStoreName).put(i),D(r,`Transaction aborted while saving project: ${e}`)}async loadProject(e){let t=await O((await this.getDB()).transaction(this.projectsStoreName,`readonly`).objectStore(this.projectsStoreName).get(e));return t?(t.dichotomousKey=t.dichotomousKey||[],t.figures=t.figures||[],t.taxa=t.taxa||[],t):null}async deleteProject(e,t){let n=(await this.getDB()).transaction([this.projectsStoreName,this.figuresStoreName],`readwrite`);n.objectStore(this.projectsStoreName).delete(e);let r=n.objectStore(this.figuresStoreName).openCursor(this.getProjectKeyRange(t));return r.onsuccess=e=>{let t=e.target.result;t&&(t.delete(),t.continue())},D(n,`Project deletion aborted for: ${e}`)}async deleteProjectRecordOnly(e){let t=(await this.getDB()).transaction(this.projectsStoreName,`readwrite`);return t.objectStore(this.projectsStoreName).delete(e),D(t,`Project record deletion aborted for: ${e}`)}async saveFigure(e,t,n){let r=(await this.getDB()).transaction(this.figuresStoreName,`readwrite`);return r.objectStore(this.figuresStoreName).put(n,this.getFigureKey(e,t)),D(r,`Transaction aborted while saving figure ID ${t}`)}async deleteFigure(e,t){let n=(await this.getDB()).transaction(this.figuresStoreName,`readwrite`);return n.objectStore(this.figuresStoreName).delete(this.getFigureKey(e,t)),D(n,`Transaction aborted while deleting figure ID ${t}`)}async cleanupOrphanFigures(e,t){let n=(await this.getDB()).transaction(this.figuresStoreName,`readwrite`),r=n.objectStore(this.figuresStoreName).openCursor(this.getProjectKeyRange(e));return r.onsuccess=e=>{let n=e.target.result;if(n){let e=this.parseFigureId(n.key);t.has(e)||n.delete(),n.continue()}},D(n,`Orphan cleanup transaction aborted for project: ${e}`)}async getFigure(e,t){return await O((await this.getDB()).transaction(this.figuresStoreName,`readonly`).objectStore(this.figuresStoreName).get(this.getFigureKey(e,t)))||null}async cloneProjectFigures(e,t){let n=(await this.getDB()).transaction(this.figuresStoreName,`readwrite`),r=n.objectStore(this.figuresStoreName),i=r.openCursor(this.getProjectKeyRange(e));return i.onsuccess=e=>{let n=e.target.result;if(n){let e=this.parseFigureId(n.key),i=n.value;r.put(i,this.getFigureKey(t,e)),n.continue()}},D(n,`Cloning figures transaction aborted from "${e}" to "${t}"`)}async deleteProjectFigures(e){let t=(await this.getDB()).transaction(this.figuresStoreName,`readwrite`),n=t.objectStore(this.figuresStoreName).openCursor(this.getProjectKeyRange(e));return n.onsuccess=e=>{let t=e.target.result;t&&(t.delete(),t.continue())},D(t,`Figure cleanup aborted for displaced project: ${e}`)}},A=new class{storage=new k;pendingUploads=new Map;pendingDeletes=new Set;commitPromise=null;async getProjectList(){return this.storage.getProjectList()}async saveProject(e,t,n){let r=await this.storage.loadProject(e),i=r?.projectUid&&r.projectUid!==t?r.projectUid:null;if(await this.storage.saveProject(e,t,n),await this.commitStagedChanges(t,n.figures),i)try{await this.storage.deleteProjectFigures(i)}catch(e){console.warn(`Could not reclaim figure blobs for displaced project "${i}":`,e)}}async loadProject(e){this.resetActiveImageCache();let t=await this.storage.loadProject(e);return t?.projectUid&&await this.storage.cleanupOrphanFigures(t.projectUid,new Set(t.figures.map(e=>e.id))),t}async deleteProject(e){let t=await this.storage.loadProject(e);if(t)return this.storage.deleteProject(e,t.projectUid)}async deleteProjectRecord(e){return this.storage.deleteProjectRecordOnly(e)}async cloneProjectFigures(e,t){return this.storage.cloneProjectFigures(e,t)}clearStagedChanges(){this.pendingUploads.clear(),this.pendingDeletes.clear()}getStagingSnapshot(){return{uploads:new Map(this.pendingUploads),deletes:new Set(this.pendingDeletes)}}restoreStagingSnapshot(e){let t=new Set([...this.pendingUploads.keys(),...this.pendingDeletes,...e.uploads.keys(),...e.deletes]);for(let n of t){let t=this.pendingUploads.get(n)===e.uploads.get(n),r=this.pendingDeletes.has(n)===e.deletes.has(n);if(t&&r)continue;let i=j.get(n);i&&(URL.revokeObjectURL(i),j.delete(n))}this.pendingUploads=new Map(e.uploads),this.pendingDeletes=new Set(e.deletes)}resetActiveImageCache(){te(),this.clearStagedChanges()}deleteFigureBinary(e){this.pendingUploads.delete(e),this.pendingDeletes.add(e)}uploadFigureBinary(e,t){this.pendingDeletes.delete(e),this.pendingUploads.set(e,t)}async getFigureBinary(e,t){return this.pendingUploads.has(t)?this.pendingUploads.get(t):this.pendingDeletes.has(t)?null:this.storage.getFigure(e,t)}async commitStagedChanges(e,t){let n=this.commitPromise??Promise.resolve(),r=new Map(this.pendingUploads),i=new Set(this.pendingDeletes),a=(async()=>{await n.catch(()=>{});try{let n=new Set(t.map(e=>e.id));for(let[t,i]of r)n.has(t)&&await this.storage.saveFigure(e,t,i);for(let t of i)await this.storage.deleteFigure(e,t);await this.storage.cleanupOrphanFigures(e,n);for(let[e,t]of r)this.pendingUploads.get(e)===t&&this.pendingUploads.delete(e);for(let e of i)this.pendingDeletes.delete(e)}catch(e){throw e instanceof Error&&e.name===`QuotaExceededError`&&alert(`⚠️ Browser storage is full! Could not save the latest images. Please delete old workspaces to free up space.`),e}})().finally(()=>{this.commitPromise===a&&(this.commitPromise=null)});return this.commitPromise=a,a}},j=new Map;function ee(e){return new Promise((t,n)=>{let r=new FileReader;r.onloadend=()=>t(r.result),r.onerror=n,r.readAsDataURL(e)})}function te(){for(let e of j.values())URL.revokeObjectURL(e);j.clear()}function M(e){return e.reduce((e,t)=>{let n=Number(t?.id);return isNaN(n)?e:Math.max(e,n)},0)+1}function ne(e,t,n){let r=e.findIndex(e=>e.id===t);if(r===-1)return null;let i={...e[r],...n},a=[...e];return a[r]=i,a}function re(e,t){return e.filter(e=>!t.has(e.id))}function ie(e,t,n){let r=[...e],[i]=r.splice(t,1);return r.splice(n,0,i),r}function ae(t){let n=M(t),r=t.length+1,i=-1,a=null;for(let e=t.length-1;e>=0;e--){let n=t[e];if(n.branch1.kind===`empty`){i=e,a=`branch1`;break}else if(n.branch2.kind===`empty`){i=e,a=`branch2`;break}}let o={kind:`linked`,targetId:n},s=e=>e.kind===`unresolved`&&e.couplet===r?o:e;return{key:[...t.map((e,t)=>{let n={...e};return n.branch1=s(n.branch1),n.branch2=s(n.branch2),t===i&&a&&(n[a]=o),n}),{id:n,alt1:``,alt2:``,branch1:e,branch2:e}],newId:n}}function oe(e,t,n,r,i,a){let o=e.length;if(n!==void 0){let t=e.findIndex(e=>e.id===n);t!==-1&&(o=r===`above`?t:t+1)}let s=e.reduce((e,t)=>Math.max(e,t.id),0),c=new Map;t.forEach((e,t)=>{c.set(e.id,s+t+1)});let l=e=>e.kind===`linked`&&c.has(e.targetId)?{kind:`linked`,targetId:c.get(e.targetId)}:e,u=t.map(e=>({...e,id:c.get(e.id),branch1:l(e.branch1),branch2:l(e.branch2)})),d=[...e];return d.splice(o,0,...u),i&&a.length>0&&(d=d.map(e=>{let t=a.filter(t=>t.sourceId===e.id);if(t.length===0)return e;let n={...e};return t.forEach(e=>{let t=c.get(e.targetOldId);t!==void 0&&(n[e.field]={kind:`linked`,targetId:t})}),n})),{key:d,newIds:u.map(e=>e.id)}}function se(n,r){let i=[];return{key:n.filter(e=>!r.has(e.id)).map(n=>{let a={...n},o=t(n.branch1);o!==null&&r.has(o)&&(i.push({sourceId:n.id,field:`branch1`,targetOldId:o}),a.branch1=e);let s=t(n.branch2);return s!==null&&r.has(s)&&(i.push({sourceId:n.id,field:`branch2`,targetOldId:s}),a.branch2=e),a}),severedLinks:i}}function ce(n,r){let i=n=>{let i=t(n);return i!==null&&r.has(i)?e:n};return n.filter(e=>!r.has(e.id)).map(e=>({...e,branch1:i(e.branch1),branch2:i(e.branch2)}))}function le(e,t){let n=!1;return{key:e.map(e=>t.has(e.id)?(n=!0,{...e,alt1:e.alt2,alt2:e.alt1,branch1:e.branch2,branch2:e.branch1}):e),modified:n}}function ue(e,t,n,r){if(t===n)return null;let i=[...e],a=i.findIndex(e=>e.id===t),o=i.findIndex(e=>e.id===n);if(a===-1||o===-1)return console.warn(`Aborted reordering: srcIdx (${a}) or targetIdx (${o}) was invalid.`),null;let[s]=i.splice(a,1),c=o;return r===`above`&&a<o?c--:r===`below`&&a>o&&c++,i.splice(c,0,s),i}function de(e){let r=new Map(e.map(e=>[e.id,e])),i=e=>{let n=t(e);return n!==null&&r.has(n)?n:null},a={taxon:1,linked:2,unresolved:2,broken:3,empty:3},o=new Map,s=new Set,c=e=>{switch(n(e,r)){case`taxon`:return 0;case`linked`:return l(e.targetId);case`unresolved`:return e.couplet||0;default:return 1e4}},l=e=>{if(!r.has(e))return 0;if(o.has(e))return o.get(e);if(s.has(e))return 0;s.add(e);let t=r.get(e),n=c(t.branch1),i=c(t.branch2);s.delete(e);let a=1+Math.max(n,i);return o.set(e,a),a};e.forEach(e=>l(e.id));let u=e.map(e=>{let t=n(e.branch1,r),i=n(e.branch2,r),o=a[t],s=a[i],l=!1;if(o>s)l=!0;else if(o===s&&o===2){let n=c(e.branch1),r=c(e.branch2);(r<n||r===n&&t!==i&&i===`linked`)&&(l=!0)}return l?{...e,alt1:e.alt2,alt2:e.alt1,branch1:e.branch2,branch2:e.branch1}:{...e}}),d=new Map(u.map(e=>[e.id,e])),f=new Map;u.forEach(e=>{let t=i(e.branch1);t!==null&&f.set(t,(f.get(t)||0)+1);let n=i(e.branch2);n!==null&&f.set(n,(f.get(n)||0)+1)});let p=u.filter(e=>!f.has(e.id));p.length===0&&u.length>0&&p.push(u[0]);let m=new Set,h=[],g=e=>{let t=[e];for(;t.length>0;){let e=t.pop();if(e===0||m.has(e))continue;let n=d.get(e);if(!n)continue;m.add(e),h.push(n);let r=i(n.branch2);r!==null&&!m.has(r)&&t.push(r);let a=i(n.branch1);a!==null&&!m.has(a)&&t.push(a)}};return p.forEach(e=>g(e.id)),u.forEach(e=>{m.has(e.id)||g(e.id)}),h}function fe(e,t){let{idToFig:n,displayNumToFig:r,filenameToFig:i}=T(e),a=[],o=new Set;for(let e of t){let t=[e.alt1,e.alt2];for(let e of t){if(!e)continue;let t,s=C();for(;(t=s.exec(e))!==null;){let e=parseInt(t[1].trim(),10),r=n.get(e);r&&!o.has(r.id)&&(o.add(r.id),a.push(r))}let c=w();for(;(t=c.exec(e))!==null;){let e=t[1].trim(),n,s=parseInt(e,10);if(!isNaN(s)&&String(s)===e&&r.has(s))n=r.get(s);else{let t=e.toLowerCase();i.has(t)&&(n=i.get(t))}n&&!o.has(n.id)&&(o.add(n.id),a.push(n))}}}for(let t of e)o.has(t.id)||a.push(t);return a}function pe(e,t,n){if(!e)return e;let r=t.length,{filenameToFig:i}=T(t);return e=e.replace(C(),(e,t)=>{let r=parseInt(t.trim(),10),i=n.get(r);return i===void 0?`[Broken Fig: ID ${r}]`:`(Fig. ${i})`}),e=e.replace(w(),(e,t)=>{let a=t.trim(),o=parseInt(a,10);if(!isNaN(o)&&String(o)===a&&o>=1&&o<=r)return`(Fig. ${o})`;let s=i.get(a.toLowerCase());if(s){let e=n.get(s.id);if(e!==void 0)return`(Fig. ${e})`}return`[Broken Fig: ${a}]`}),e}function me(e,t){if(!e)return``;let{displayNumToFig:n,filenameToFig:r}=T(t);return e.replace(w(),(e,t)=>{let i=t.trim(),a=parseInt(i,10);if(!isNaN(a)&&String(a)===i&&n.has(a))return`[figID: ${n.get(a).id}]`;let o=r.get(i.toLowerCase());return o?`[figID: ${o.id}]`:e})}function he(e,t){if(!e)return``;let{idToDisplayNum:n}=T(t);return e.replace(C(),(e,t)=>{let r=parseInt(t.trim(),10),i=n.get(r);return i===void 0?e:`[fig: ${i}]`})}function N(e){return e.trim().toLowerCase()}function ge(e,t){let n=N(t);if(n!==``)return e.find(e=>N(e.scientificName)===n)??e.find(e=>N(e.vernacularName)===n)}function _e(e,t=``){return{id:e,scientificName:t.trim(),auctor:``,vernacularName:``,synonyms:[],description:``,biology:``,distribution:``,confusables:[]}}function ve(e,t=!1){let n=new Map;return e.forEach(e=>{let t=N(e.scientificName);t&&!n.has(t)&&n.set(t,e.id)}),t&&e.forEach(e=>{let t=N(e.vernacularName);t&&!n.has(t)&&n.set(t,e.id)}),n}function ye(e,t){return e.map(e=>{let n=t(e.branch1),r=t(e.branch2);return n===e.branch1&&r===e.branch2?e:{...e,branch1:n,branch2:r}})}function be(t,n,r){let i=ve(n),a=[...n],o=M(a),s=!1;return{key:ye(t,t=>{let n=r(t);if(n===null)return t;s=!0;let c=n.trim();if(c===``)return e;let l=N(c),u=i.get(l);if(u!==void 0)return{kind:`taxon`,taxonId:u};let d=o++;return a.push(_e(d,c)),i.set(l,d),{kind:`taxon`,taxonId:d}}),taxa:a,changed:s}}function xe(e,t){return be(e,t,e=>e.kind===`taxonDraft`?e.name:null)}function Se(e,t){let n=be(e,t,e=>{let t=e;return e.kind===`taxon`&&typeof t.taxonId!=`number`&&typeof t.name==`string`?t.name:null});return{key:n.key,taxa:n.taxa}}function Ce(e,t){let n=ve(t,!0),r=!1;return{key:ye(e,e=>{if(e.kind!==`taxonDraft`)return e;let t=n.get(N(e.name));return t===void 0?e:(r=!0,{kind:`taxon`,taxonId:t})}),changed:r}}function we(t,n){return{key:ye(t,t=>t.kind===`taxon`&&n.has(t.taxonId)?e:t)}}var Te=class{ids=new Set;get(){return this.ids}has(e){return this.ids.has(e)}get size(){return this.ids.size}toggle(e,t){t?this.ids.has(e)?this.ids.delete(e):this.ids.add(e):this.ids=new Set([e])}replace(e){this.ids=new Set(e)}clear(){this.ids.clear()}},Ee=`TSKey`,De=`0.0.3`;function P(){return crypto.randomUUID()}var Oe=[`dichotomousKey`,`figures`,`taxa`];function ke(e,n){let r=new Set;if(e.length===0)return r;let i=n||new Map(e.map(e=>[e.id,e])),a=[e[0].id];for(;a.length>0;){let e=a.pop();if(!r.has(e)){r.add(e);let n=i.get(e);if(n){let e=t(n.branch2);e!==null&&a.push(e);let r=t(n.branch1);r!==null&&a.push(r)}}}return r}function Ae(e,n){let r={steps:[],reachable:!1};if(e.length===0)return r;let i=new Map(e.map(e=>[e.id,e])),a=new Map;if(e.forEach((e,t)=>a.set(e.id,t)),!i.has(n))return r;let o=e[0].id,s=new Map,c=new Set([o]),l=[o];for(;l.length>0;){let e=l.shift();if(e===n)break;let r=i.get(e);if(!r)continue;let a=[[r.branch1,`a`],[r.branch2,`b`]];for(let[n,r]of a){let a=t(n);a!==null&&i.has(a)&&!c.has(a)&&(c.add(a),s.set(a,{parentId:e,choice:r}),l.push(a))}}if(!c.has(n))return r;let u=[],d=n,f;for(;d!==void 0;){u.push({id:d,choice:f});let e=s.get(d);f=e?.choice,d=e?.parentId}return u.reverse(),{steps:u.map(e=>({id:e.id,stepNum:(a.get(e.id)??0)+1,choice:e.choice})),reachable:!0}}function je(e,n){let r=new Map;if(e.length===0)return r;let i=new Map,a=new Map,o=new Map,s=new Set(n.map(e=>e.id)),{displayNumToFig:c,filenameToFig:l}=T(n),u=e=>{let t=e.trim();if(t===``)return!1;let n=parseInt(t,10);return!isNaN(n)&&String(n)===t?c.has(n):l.has(t.toLowerCase())};e.forEach((e,n)=>{i.set(e.id,e),a.set(e.id,n);let r=t(e.branch1);if(r!==null){let t=o.get(r);t||o.set(r,t=new Set),t.add(e.id)}let s=t(e.branch2);if(s!==null){let t=o.get(s);t||o.set(s,t=new Set),t.add(e.id)}});let d=ke(e,i),f=C(),p=w(),m=(e,t)=>{let n=[];if(!e)return n;let r=[];for(let t of e.matchAll(f)){let e=parseInt(t[1],10);!s.has(e)&&!r.includes(e)&&r.push(e)}r.forEach(e=>{n.push({severity:`warning`,message:`Choice ${t} references a missing or deleted figure (Internal ID: ${e}).`})});let i=[];for(let t of e.matchAll(p)){let e=t[1].trim();!u(e)&&!i.includes(e)&&i.push(e)}return i.forEach(e=>{n.push({severity:`warning`,message:`Choice ${t} references an unresolved figure reference '[fig: ${e}]'.`})}),n};return e.forEach((e,t)=>{let n=[];e.branch1.kind===`unresolved`?n.push({severity:`error`,message:`Choice A points to step '${e.branch1.couplet}' which does not exist yet.`}):e.branch1.kind===`empty`&&n.push({severity:`warning`,message:`Choice A is incomplete. Assign a Taxa or destination step.`}),e.branch2.kind===`unresolved`?n.push({severity:`error`,message:`Choice B points to step '${e.branch2.couplet}' which does not exist yet.`}):e.branch2.kind===`empty`&&n.push({severity:`warning`,message:`Choice B is incomplete. Assign a Taxa or destination step.`}),n.push(...m(e.alt1,`A`)),n.push(...m(e.alt2,`B`)),t>0&&!d.has(e.id)&&n.push({severity:`warning`,message:`Orphaned: This step is unreachable from Step #1.`}),t===0&&o.has(e.id)&&n.push({severity:`warning`,message:`Step #1 should be the key's starting point, but other steps link here.`}),e.branch1.kind===`linked`&&(e.branch1.targetId===e.id?n.push({severity:`error`,message:`Choice A loops directly into its own key step.`}):i.has(e.branch1.targetId)||n.push({severity:`error`,message:`Choice A points to an invalid or deleted step.`})),e.branch2.kind===`linked`&&(e.branch2.targetId===e.id?n.push({severity:`error`,message:`Choice B loops directly into its own key step.`}):i.has(e.branch2.targetId)||n.push({severity:`error`,message:`Choice B points to an invalid or deleted step.`}));let s=o.get(e.id);if(s&&s.size>1){let e=[];s.forEach(t=>{let n=a.get(t);n!==void 0&&n!==-1&&e.push(`#${n+1}`)}),n.push({severity:`warning`,message:`Convergence: Multiple steps (${e.join(`, `)}) link here.`})}n.length>0&&r.set(e.id,n)}),r}var Me=class{state;hasUncommittedChanges=!1;editScope=null;persistedTitle=``;activeProjectUid=P();onProjectPersisted;undoStack=[];redoStack=[];maxHistoryLimit;savedDepth=0;coupletSelection=new Te;figureSelection=new Te;taxonSelection=new Te;_draggedId=null;activeCoupletId=null;clipboardBuffer=[];clipboardMode=`copy`;cutIncomingLinksBuffer=[];constructor(e,t=[],n=`Untitled Key`,r=100,i=[]){this.state={title:n,dichotomousKey:e,figures:t,taxa:i},this.maxHistoryLimit=r,this.hasUncommittedChanges=!1,this.persistedTitle=n}getTitle(){return this.state.title}getPersistedTitle(){return this.persistedTitle}getActiveProjectUid(){return this.activeProjectUid}setTitle(e){let t=e.trim();this.state.title!==t&&(this.saveCheckpoint(),this.state.title=t||`Untitled Key`,this.hasUncommittedChanges=!0)}getKey(){return this.state.dichotomousKey}getFigures(){return this.state.figures||[]}getTaxa(){return this.state.taxa||[]}getSelectedCoupletIds(){return this.coupletSelection.get()}setActiveCouplet(e){this.activeCoupletId=e}getActiveCoupletId(){return this.activeCoupletId}clearActiveCouplet(){this.activeCoupletId=null}get draggedCoupletId(){return this._draggedId}startDraggingCouplet(e){this._draggedId=e}stopDraggingCouplet(){this._draggedId=null}markSaved(){this.savedDepth=this.undoStack.length,this.hasUncommittedChanges=!1,this.editScope=null}hasUnsavedChanges(){return this.undoStack.length!==this.savedDepth||this.hasUncommittedChanges}resetTrackingContext(){this.undoStack=[],this.redoStack=[],this.savedDepth=0,this.hasUncommittedChanges=!1,this.editScope=null,this.coupletSelection.clear(),this.figureSelection.clear(),this.taxonSelection.clear(),this.activeCoupletId=null,this._draggedId=null}captureState(){let e={title:this.state.title};for(let t of Oe)e[t]=(this.state[t]||[]).map(e=>({...e}));return e}captureHistoryEntry(){return{state:this.captureState(),staging:A.getStagingSnapshot()}}saveCheckpoint(){this.savedDepth!==null&&this.savedDepth>this.undoStack.length&&(this.savedDepth=null),this.redoStack=[],this.undoStack.push(this.captureHistoryEntry()),this.undoStack.length>this.maxHistoryLimit&&(this.undoStack.shift(),this.savedDepth!==null&&(this.savedDepth=this.savedDepth>0?this.savedDepth-1:null)),this.hasUncommittedChanges=!1,this.editScope=null}beginScopedEdit(e){this.editScope!==e&&this.saveCheckpoint(),this.editScope=e}discardCutBuffer(){this.clipboardMode===`cut`&&(this.clipboardMode=`copy`,this.cutIncomingLinksBuffer=[])}undo(){if(this.undoStack.length===0)return!1;this.redoStack.push(this.captureHistoryEntry());let e=this.undoStack.pop();return this.state=e.state,A.restoreStagingSnapshot(e.staging),this.hasUncommittedChanges=!1,this.editScope=null,this.discardCutBuffer(),!0}redo(){if(this.redoStack.length===0)return!1;this.undoStack.push(this.captureHistoryEntry());let e=this.redoStack.pop();return this.state=e.state,A.restoreStagingSnapshot(e.staging),this.hasUncommittedChanges=!1,this.editScope=null,this.discardCutBuffer(),!0}get canUndo(){return this.undoStack.length>0}get canRedo(){return this.redoStack.length>0}copySelectedCouplets(){let e=this.getSelectedCoupletIds();e.size!==0&&(this.clipboardBuffer=this.state.dichotomousKey.filter(t=>e.has(t.id)).map(e=>({...e})),this.clipboardMode=`copy`,this.cutIncomingLinksBuffer=[])}hasClipboardData(){return this.clipboardBuffer.length>0}generateInboundLinksMap(){let e=new Map;return this.state.dichotomousKey.forEach((n,r)=>{let i=r+1,a=t(n.branch1);a!==null&&(e.has(a)||e.set(a,[]),e.get(a).push(`${i}a`));let o=t(n.branch2);o!==null&&(e.has(o)||e.set(o,[]),e.get(o).push(`${i}b`))}),e}endTypingSession(){this.hasUncommittedChanges&&(this.hasUncommittedChanges=!1,this.editScope=null)}updateCouplet(e,t){this.beginScopedEdit(`key`);let n=ne(this.state.dichotomousKey,e,t);n&&(this.state.dichotomousKey=n,this.hasUncommittedChanges=!0)}addCouplet(){this.saveCheckpoint();let{key:e,newId:t}=ae(this.state.dichotomousKey);return this.state.dichotomousKey=e,this.hasUncommittedChanges=!0,t}pasteCouplets(e,t=`below`){if(this.clipboardBuffer.length===0)return!1;this.saveCheckpoint();let{key:n,newIds:r}=oe(this.state.dichotomousKey,this.clipboardBuffer,e,t,this.clipboardMode===`cut`,this.cutIncomingLinksBuffer);return this.clipboardMode===`cut`&&this.cutIncomingLinksBuffer.length>0&&(this.clipboardMode=`copy`,this.cutIncomingLinksBuffer=[]),this.state.dichotomousKey=n,this.setSelectionBatch(r),this.hasUncommittedChanges=!0,!0}cutSelectedCouplets(){let e=this.getSelectedCoupletIds();if(e.size===0)return;this.saveCheckpoint(),this.activeCoupletId!==null&&e.has(this.activeCoupletId)&&(this.activeCoupletId=null),this.clipboardBuffer=this.state.dichotomousKey.filter(t=>e.has(t.id)).map(e=>({...e})),this.clipboardMode=`cut`;let{key:t,severedLinks:n}=se(this.state.dichotomousKey,e);this.state.dichotomousKey=t,this.cutIncomingLinksBuffer=n,this.coupletSelection.clear(),this.hasUncommittedChanges=!0}deleteSelectedCouplets(){if(this.coupletSelection.size===0)return;this.saveCheckpoint();let e=new Set(this.coupletSelection.get());this.activeCoupletId!==null&&e.has(this.activeCoupletId)&&(this.activeCoupletId=null),this.state.dichotomousKey=ce(this.state.dichotomousKey,e),this.coupletSelection.clear(),this.hasUncommittedChanges=!0}swapSelectedCouplets(){if(this.coupletSelection.size===0)return!1;this.saveCheckpoint();let{key:e,modified:t}=le(this.state.dichotomousKey,this.coupletSelection.get());return this.state.dichotomousKey=e,t?(this.hasUncommittedChanges=!0,!0):!1}reorderCouplets(e,t,n=`above`){let r=ue(this.state.dichotomousKey,e,t,n);return r===null?!1:(this.saveCheckpoint(),this.state.dichotomousKey=r,this.hasUncommittedChanges=!0,!0)}autoOrderCouplets(){this.state.dichotomousKey.length!==0&&(this.saveCheckpoint(),this.state.dichotomousKey=de(this.state.dichotomousKey),this.hasUncommittedChanges=!0)}getSelectedFigureIds(){return this.figureSelection.get()}clearSelectionsExcept(e){for(let t of[this.coupletSelection,this.figureSelection,this.taxonSelection])t!==e&&t.clear()}toggleFigureSelection(e,t){t||this.clearSelectionsExcept(this.figureSelection),this.figureSelection.toggle(e,t)}clearFigureSelection(){this.figureSelection.clear()}deleteSelectedFigures(){this.figureSelection.size!==0&&(this.saveCheckpoint(),this.state.figures=re(this.state.figures,this.figureSelection.get()),this.figureSelection.clear(),this.hasUncommittedChanges=!0)}addFigure(e,t){this.saveCheckpoint();let n=this.state.figures||[],r=M(n);return this.state.figures=[...n,{id:r,filename:e,caption:t}],this.hasUncommittedChanges=!0,r}updateFigure(e,t){this.beginScopedEdit(`figures`);let n=ne(this.state.figures,e,t);n&&(this.state.figures=n,this.hasUncommittedChanges=!0)}reorderFigures(e,t){!this.state.figures||e===t||(this.saveCheckpoint(),this.state.figures=ie(this.state.figures,e,t),this.hasUncommittedChanges=!0)}autoOrderFigures(){let e=this.state.figures||[];e.length===0||this.state.dichotomousKey.length===0||(this.saveCheckpoint(),this.state.figures=fe(e,this.state.dichotomousKey),this.hasUncommittedChanges=!0)}getSelectedTaxonIds(){return this.taxonSelection.get()}toggleTaxonSelection(e,t){t||this.clearSelectionsExcept(this.taxonSelection),this.taxonSelection.toggle(e,t)}clearTaxonSelection(){this.taxonSelection.clear()}deleteSelectedTaxa(){if(this.taxonSelection.size===0)return;this.saveCheckpoint();let e=new Set(this.taxonSelection.get());this.state.taxa=re(this.state.taxa,e),this.state.dichotomousKey=we(this.state.dichotomousKey,e).key,this.taxonSelection.clear(),this.hasUncommittedChanges=!0}addTaxon(e=``){this.saveCheckpoint();let t=this.state.taxa||[],n=M(t);return this.state.taxa=[...t,_e(n,e)],this.hasUncommittedChanges=!0,n}updateTaxon(e,t){this.beginScopedEdit(`taxa`);let n=ne(this.state.taxa,e,t);n&&(this.state.taxa=n,this.hasUncommittedChanges=!0)}relinkTaxonDrafts(){let e=Ce(this.state.dichotomousKey,this.state.taxa);return e.changed?(this.state.dichotomousKey=e.key,this.hasUncommittedChanges=!0,!0):!1}reorderTaxa(e,t){!this.state.taxa||e===t||(this.saveCheckpoint(),this.state.taxa=ie(this.state.taxa,e,t),this.hasUncommittedChanges=!0)}createTaxonForBranch(e,t,n=`scientific`){let r=this.state.dichotomousKey.find(t=>t.id===e);if(!r)return null;let i=r[t];if(i.kind!==`taxonDraft`)return null;this.saveCheckpoint();let a=ge(this.state.taxa,i.name),o;if(a)o=a.id;else{o=M(this.state.taxa);let e=_e(o,n===`scientific`?i.name:``);n===`vernacular`&&(e.vernacularName=i.name),this.state.taxa=[...this.state.taxa,e]}return this.state.dichotomousKey=ne(this.state.dichotomousKey,e,{[t]:{kind:`taxon`,taxonId:o}})??this.state.dichotomousKey,this.hasUncommittedChanges=!0,o}importJsonData(e){try{let t=null,n=[],r=[],i=`Untitled Key`;if(S(e)&&S(e.data)){let a=e.data;c(a.key)&&(t=a.key,l(a.figures)&&(n=a.figures),Array.isArray(a.taxa)&&(r=a.taxa)),typeof a.title==`string`?i=a.title:typeof e.title==`string`&&(i=e.title)}if(!t&&c(e)&&(t=e),!t)return{success:!1,errors:[`The uploaded file does not match the required schema structure.`]};let a=[];n.length>0&&(a=[...n],n=n.map(e=>{let{binaryData:t,...n}=e;return n}));let o=Se(t,r),s=xe(o.key,o.taxa);return this.saveCheckpoint(),this.state.title=i,this.activeProjectUid=P(),this.persistedTitle=i,this.state.dichotomousKey=s.key,this.state.figures=n,this.state.taxa=s.taxa,A.resetActiveImageCache(),this.clearSelection(),this.activeCoupletId=null,this.hasUncommittedChanges=!0,{success:!0,errors:[],importedFigures:a}}catch(e){return{success:!1,errors:[e instanceof Error?e.message:`Unknown engine exception during parsing the json file.`]}}}setProjectPersistedListener(e){this.onProjectPersisted=e}commitPersistedTitle(e){this.persistedTitle=e,this.onProjectPersisted?.(e)}async createNewProject(e){this.state.title=e,this.activeProjectUid=P(),this.commitPersistedTitle(e),this.state.dichotomousKey=[],this.state.figures=[],this.state.taxa=[],this.resetTrackingContext(),A.resetActiveImageCache(),await this.saveToStorage()}async loadProject(e){let t=await A.loadProject(e);if(t){this.state.title=t.title,this.activeProjectUid=t.projectUid||P(),this.commitPersistedTitle(t.title);let e=Se(t.dichotomousKey,t.taxa),n=Ce(e.key,e.taxa);return this.state.dichotomousKey=n.key,this.state.taxa=e.taxa,this.state.figures=t.figures,this.resetTrackingContext(),!0}return!1}getProjectData(){return{dichotomousKey:this.state.dichotomousKey,figures:this.state.figures,taxa:this.state.taxa}}async saveToStorage(){let e=this.persistedTitle&&this.persistedTitle!==this.state.title,t=this.persistedTitle;try{await A.saveProject(this.state.title,this.activeProjectUid,this.getProjectData()),e&&t&&await A.deleteProjectRecord(t),this.commitPersistedTitle(this.state.title),this.markSaved()}catch(n){throw console.error(`Failed to save or rename project workspace:`,n),e&&t&&(this.state.title=t,A.clearStagedChanges()),n}}async saveAsProject(e){let t=this.persistedTitle,n=this.activeProjectUid,r=P();try{await A.cloneProjectFigures(n,r),this.state.title=e,this.activeProjectUid=r,await A.saveProject(e,r,this.getProjectData()),this.commitPersistedTitle(e),this.markSaved()}catch(e){throw console.error(`Save As Operation Failed:`,e),this.state.title=t,this.activeProjectUid=n,e}}async loadFromStorage(e=[],t=[],n=`Untitled Key`,r=[]){let i=n,a=await this.loadProject(i);if(!a){let n=Se(e,r),a=xe(n.key,n.taxa);this.state={title:i,dichotomousKey:a.key,figures:t,taxa:a.taxa},this.persistedTitle=i,this.activeProjectUid=P(),A.resetActiveImageCache(),this.resetTrackingContext()}return a}toggleSelection(e,t){t||this.clearSelectionsExcept(this.coupletSelection),this.coupletSelection.toggle(e,t)}clearSelection(){this.coupletSelection.size!==0&&this.coupletSelection.clear()}setSelectionBatch(e){this.coupletSelection.replace(e)}selectAll(){this.coupletSelection.replace(this.state.dichotomousKey.map(e=>e.id))}runDiagnostics(){return je(this.state.dichotomousKey,this.state.figures)}resolveTextReferences(e,t){return pe(e,this.state.figures,t)}encodeFigureTokens(e){return me(e,this.state.figures)}decodeTextReferencesForEditor(e){return he(e,this.state.figures)}},Ne=`dichotomous_key_ui`,Pe={isFiguresHidden:!1,isPrintHidden:!1,isImagesHidden:!1,isTaxaHidden:!1,collapsedPanels:{editor:!1,figures:!1,taxa:!1,print:!1},activeProjectTitle:`Untitled Key`,leadFormat:g,showBackReference:!1,nameDisplayMode:d},Fe=class{active=!1;fieldKey=null;timeoutId=null;isActive(){return this.active}getFieldKey(){return this.fieldKey}start(e,t){(!this.active||this.fieldKey!==e)&&(this.clearTimer(),t(),this.active=!0,this.fieldKey=e)}extendTimeout(e,t){this.clearTimer(),this.timeoutId=window.setTimeout(()=>{this.timeoutId=null,this.active=!1,this.fieldKey=null,t()},e)}clearTimer(){this.timeoutId!==null&&(clearTimeout(this.timeoutId),this.timeoutId=null)}end(e,t){return!this.active&&this.fieldKey===null?!1:e===null||this.fieldKey===e?(this.active=!1,this.fieldKey=null,this.clearTimer(),t(),!0):!1}},Ie=class{couplets=new Fe;figures=new Fe;taxa=new Fe;clearAll(){this.couplets.clearTimer(),this.figures.clearTimer(),this.taxa.clearTimer()}},Le=class{state;typing=new Ie;constructor(){this.state=this.loadFromStorage()}get isFiguresHidden(){return this.state.isFiguresHidden}get isImagesHidden(){return this.state.isImagesHidden}get isTaxaHidden(){return this.state.isTaxaHidden}get nameDisplayMode(){return this.state.nameDisplayMode}get isPrintHidden(){return this.state.isPrintHidden}isPanelCollapsed(e){return this.state.collapsedPanels[e]??!1}get activeProjectTitle(){return this.state.activeProjectTitle||`Untitled Key`}get leadFormat(){return this.state.leadFormat}get showBackReference(){return this.state.showBackReference}setActiveProjectTitle(e){this.state={...this.state,activeProjectTitle:e.trim()},this.persist()}toggleFigures(){this.state={...this.state,isFiguresHidden:!this.state.isFiguresHidden},this.persist()}togglePrint(){this.state={...this.state,isPrintHidden:!this.state.isPrintHidden},this.persist()}toggleImages(){this.state={...this.state,isImagesHidden:!this.state.isImagesHidden},this.persist()}toggleTaxa(){this.state={...this.state,isTaxaHidden:!this.state.isTaxaHidden},this.persist()}togglePanelCollapse(e){let t=!(this.state.collapsedPanels[e]??!1);this.state={...this.state,collapsedPanels:{...this.state.collapsedPanels,[e]:t}},this.persist()}setNameDisplayMode(e){!f(e)||this.state.nameDisplayMode===e||(this.state={...this.state,nameDisplayMode:e},this.persist())}setLeadFormat(e){!_(e)||this.state.leadFormat===e||(this.state={...this.state,leadFormat:e},this.persist())}setShowBackReference(e){this.state.showBackReference!==e&&(this.state={...this.state,showBackReference:e},this.persist())}loadFromStorage(){try{let e=localStorage.getItem(Ne);if(!e)return{...Pe};let t=JSON.parse(e),n={...Pe,...t};return n.collapsedPanels={...Pe.collapsedPanels,...t.collapsedPanels??{}},_(n.leadFormat)||(n.leadFormat=g),f(n.nameDisplayMode)||(n.nameDisplayMode=d),n}catch{return{...Pe}}}persist(){try{localStorage.setItem(Ne,JSON.stringify(this.state))}catch(e){console.warn(`UIStateStore: Failed to persist UI preferences to localStorage.`,e)}}};function Re(e){e.innerHTML=`
    ...
    <div id="modal-about" class="modal-overlay" role="dialog" aria-modal="true" aria-labelledby="modal-about-title">
      <div class="modal-window about-modal-window">
        ...
        <div class="modal-body about-modal-body">
          <h4 class="about-title">${Ee}</h4>
          <p class="about-version">
            Version ${De} (2026 Engine Core)
          </p>
    ...
    `}function ze(e){document.querySelector(`.figure-column`)?.classList.toggle(`is-hidden`,e.isFiguresHidden),document.querySelector(`.taxa-column`)?.classList.toggle(`is-hidden`,e.isTaxaHidden),document.querySelector(`.print-column`)?.classList.toggle(`is-hidden`,e.isPrintHidden);for(let t of[`editor`,`figures`,`taxa`,`print`]){let n=document.querySelector(`[data-panel="${t}"]`);if(!n)continue;let r=e.isPanelCollapsed(t);n.classList.toggle(`is-collapsed`,r),n.querySelector(`.panel-toggle`)?.setAttribute(`aria-expanded`,r?`false`:`true`)}}function F(e,t,n,r=!1){let i=e.querySelector(t);return i?((r||document.activeElement!==i)&&i.value!==n&&(i.value=n),i):null}function Be(e){let{container:t,items:n,getId:r,create:i,update:a,onRemove:o}=e,s=new Map;for(let e of Array.from(t.children)){let t=e.getAttribute(`data-id`);if(t===null)continue;let n=Number(t);Number.isNaN(n)||s.set(n,e)}n.forEach((e,n)=>{let o=r(e),c=s.get(o);c?s.delete(o):c=i(e,n),t.children[n]!==c&&t.insertBefore(c,t.children[n]??null),a?.(c,e,n)}),s.forEach(e=>{o?.(e),e.remove()})}function I(e,t=`success`){let n=document.querySelector(`.toast-container`);n||(n=document.createElement(`div`),n.className=`toast-container`,n.setAttribute(`aria-live`,`polite`),document.body.appendChild(n));let r=document.createElement(`div`);r.className=`toast toast-${t}`,r.textContent=e,t===`error`?r.setAttribute(`role`,`alert`):r.setAttribute(`role`,`status`),n.appendChild(r),setTimeout(()=>{r.remove(),n&&n.childElementCount===0&&n.remove()},3e3)}function Ve(e,t){if(!document.querySelector(`.app-menu-bar`))return;let n=e=>document.getElementById(e),r=e.getSelectedCoupletIds().size,i=e.getSelectedFigureIds().size,a=e.getSelectedTaxonIds().size,o=r>0||i>0||a>0,s=r>0,c=e.getKey().length>0,l=e.hasClipboardData(),u=e.getTitle(),d=e.hasUnsavedChanges(),f=`${u}${d?` *`:``}`;document.title=`${f} - ${Ee}`;let p=document.getElementById(`active-project-title`);p&&p.textContent!==f&&(p.textContent=f);let m=n(`cmd-save`),h=n(`cmd-export-json`),g=n(`cmd-export-text`),_=n(`cmd-export-html`),v=n(`cmd-export-latex`),y=n(`cmd-undo`),b=n(`cmd-redo`),x=n(`cmd-cut`),S=n(`cmd-copy`),C=n(`cmd-paste-below`),w=n(`cmd-paste-above`),T=n(`cmd-delete`),E=n(`cmd-swap`),D=n(`cmd-clear`),O=n(`cmd-reorder-couplets`),k=n(`cmd-reorder-figures`);m&&m.classList.toggle(`has-unsaved-changes`,d),h&&(h.disabled=!c),g&&(g.disabled=!c),_&&(_.disabled=!c),v&&(v.disabled=!c),y&&(y.disabled=!e.canUndo),b&&(b.disabled=!e.canRedo),x&&(x.disabled=!s),S&&(S.disabled=!s),T&&(T.disabled=!o),E&&(E.disabled=!s),D&&(D.disabled=!o),C&&(C.disabled=!l),w&&(w.disabled=!l),O&&(O.disabled=!c),k&&(k.disabled=!c||e.getFigures().length===0);let A=n(`cmd-toggle-figures`),j=n(`cmd-toggle-images`),ee=n(`cmd-toggle-taxa`),te=n(`cmd-toggle-print`);if(A){let e=A.querySelector(`span`);e&&(e.textContent=t.isFiguresHidden?`🖼️ Show Figures Panel`:`🖼️ Hide Figures Panel`)}if(j){let e=j.querySelector(`span`);e&&(e.textContent=t.isImagesHidden?`🖼️ Show Images in Figures Panel`:`🖼️ Hide Images in Figures Panel`)}if(ee){let e=ee.querySelector(`span`);e&&(e.textContent=t.isTaxaHidden?`🦋 Show Taxa Panel`:`🦋 Hide Taxa Panel`)}if(te){let e=te.querySelector(`span`);e&&(e.textContent=t.isPrintHidden?`🖨️ Show Print Preview`:`🖨️ Hide Print Preview`)}let M=document.querySelector(`.app-shell`);M&&F(M,`#key-title-input`,e.getTitle())}function He(e,t){let n=document.getElementById(`project-hub-list`);if(n){if(e.length===0){n.innerHTML=`<div class="hub-empty">No keys saved inside local browser memory yet.</div>`;return}n.innerHTML=e.map(e=>{let n=e.name===t,r=new Date(e.lastModified).toLocaleString(),a=i(e.name);return`
        ...
        `}).join(``)}}function Ue(e,t,n,r,i=e.length){if(n===r&&r.length===1){let n=r,a=!1,o=t;for(;o<i;){if(e[o]!==n){o++;continue}let t=o;for(;t+1<i&&e[t+1]===n;)t++;if(t===o)return o;if(a)a=!1;else{let r=n.repeat(t-o+1),s=e.indexOf(r,t+1);if(s!==-1&&s+r.length<=i)a=!0;else return o}o=t+1}return-1}let a=e.indexOf(r,t);return a!==-1&&a+r.length<=i?a:-1}function We(e,t,n,r,i){let a=r,o=r;for(;o<i;){let r=n.get(o);r&&r.end<=i?(o>a&&e.push({kind:`text`,value:t.slice(a,o)}),e.push(r.atom),o=r.end,a=o):o++}i>a&&e.push({kind:`text`,value:t.slice(a,i)})}function Ge(e,t,n,r,i,a,o){let s=i,c=i,l=t=>{t>c&&We(o,e,r,c,t)};for(;s<a;){let i=!1;for(let u of n){if(s+u.open.length>a||!t.startsWith(u.open,s))continue;let d=s+u.open.length,f=Ue(t,d,u.open,u.close,a);if(f<=d)continue;l(s);let p=[];Ge(e,t,n,r,d,f,p),o.push({kind:`mark`,mark:u,children:p}),s=f+u.close.length,c=s,i=!0;break}i||s++}l(a)}function Ke(e,t){let n=[];for(let r of t.tokens){let t=r.pattern.flags.includes(`g`)?r.pattern.flags:r.pattern.flags+`g`,i=new RegExp(r.pattern.source,t),a;for(;(a=i.exec(e))!==null;){if(a[0]===``){i.lastIndex++;continue}let{html:e,className:t}=r.render(a);n.push({start:a.index,end:a.index+a[0].length,atom:{kind:`token`,src:a[0],html:e,className:t}})}}n.sort((e,t)=>e.start-t.start||t.end-t.start-(e.end-e.start));let r=[],i=0;for(let e of n)e.start<i||(r.push(e),i=e.end);return r}function qe(e,t){if(t.length===0)return e;let n=e.split(``);for(let e of t)for(let t=e.start;t<e.end;t++)n[t]=` `;return n.join(``)}function Je(e,t){return qe(e,Ke(e,t))}function Ye(e,t){if(!e)return[];let n=Ke(e,t),r=qe(e,n),i=new Map(n.map(e=>[e.start,e])),a=[...t.marks].sort((e,t)=>t.open.length-e.open.length),o=[];return Ge(e,r,a,i,0,e.length,o),o}function Xe(e){let t=``;for(let n of e)if(n.kind===`text`)t+=i(n.value);else if(n.kind===`token`)t+=`<span class="${i(n.className)}" contenteditable="false" data-src="${i(n.src)}">${n.html}</span>`;else{let{tag:e,open:r,close:a,className:o}=n.mark,s=o?` class="${i(o)}"`:``;t+=`<${e}${s} data-open="${i(r)}" data-close="${i(a)}">`+Xe(n.children)+`</${e}>`}return t}var L=Node.TEXT_NODE,Ze=Node.ELEMENT_NODE;function Qe(e){return e.dataset.src!==void 0}var $e=e=>(e.dataset.src??``).length,et=e=>(e.dataset.open??``).length,tt=e=>(e.dataset.close??``).length;function nt(e){if(e.nodeType===L)return(e.textContent??``).length;let t=e;if(Qe(t))return $e(t);let n=et(t)+tt(t);for(let e of Array.from(t.childNodes))n+=nt(e);return n}function rt(e){let t=``;for(let n of Array.from(e.childNodes))if(n.nodeType===L)t+=n.textContent??``;else if(n.nodeType===Ze){let e=n;Qe(e)?t+=e.dataset.src??``:t+=(e.dataset.open??``)+rt(e)+(e.dataset.close??``)}return t}function it(e){let t=[],n=[],r=0,i=e=>{n.push({src:r,container:e,offset:0}),Array.from(e.childNodes).forEach((a,o)=>{if(a.nodeType===L){let e=(a.textContent??``).length;t.push({node:a,start:r,end:r+e}),r+=e}else if(a.nodeType===Ze){let e=a;Qe(e)?r+=$e(e):(r+=et(e),i(e),r+=tt(e))}n.push({src:r,container:e,offset:o+1})})};return i(e),{stops:t,positions:n}}function at(e,t,n){let r=t;for(;r&&r!==e;){if(r.nodeType===Ze&&Qe(r)){let e=r.parentNode;if(!e)break;let i=Array.prototype.indexOf.call(e.childNodes,r);t=e,n=i+(n===0?0:1);break}r=r.parentNode}let i=0,a=!1,o=e=>{if(!a){if(e===t&&e.nodeType!==L){for(let t=0;t<n;t++)i+=nt(e.childNodes[t]);a=!0;return}for(let r of Array.from(e.childNodes)){if(a)return;if(r===t&&r.nodeType===L){i+=n,a=!0;return}if(r.nodeType===L)i+=(r.textContent??``).length;else if(r.nodeType===Ze){let e=r;if(Qe(e))i+=$e(e);else{if(i+=et(e),o(e),a)return;i+=tt(e)}}}}};return o(e),i}function ot(e){let t=window.getSelection();if(!t||t.rangeCount===0)return null;let n=t.getRangeAt(0);if(!e.contains(n.startContainer)||!e.contains(n.endContainer))return null;let r=at(e,n.startContainer,n.startOffset),i=at(e,n.endContainer,n.endOffset);return{start:Math.min(r,i),end:Math.max(r,i)}}function st(e,t,n,r){for(let e of n)if(t>=e.start&&t<=e.end)return{node:e.node,offset:t-e.start};if(r.length===0)return{node:e,offset:0};let i=r[0],a=Math.abs(i.src-t);for(let e of r){let n=Math.abs(e.src-t);(n<a||n===a&&e.src<=t)&&(i=e,a=n)}return{node:i.container,offset:i.offset}}function ct(e,t,n){let r=window.getSelection();if(!r)return;let{stops:i,positions:a}=it(e),o=st(e,t,i,a),s=t===n?o:st(e,n,i,a),c=document.createRange();c.setStart(o.node,o.offset),c.setEnd(s.node,s.offset),r.removeAllRanges(),r.addRange(c)}function lt(e,t){let{open:n,close:r}=t,i=n===r&&n.length===1,a=[],o=0;for(;o<e.length;){if(i&&e[o]===n){let t=o;for(;t+1<e.length&&e[t+1]===n;)t++;if(t>o){o=t+1;continue}}if(e.startsWith(n,o)){let t=o+n.length,i=Ue(e,t,n,r);if(i>t){a.push({start:o,end:i+r.length,contentStart:t,contentEnd:i}),o=i+r.length;continue}}o++}return a}function ut(e,t,n,r=e){let{open:i,close:a}=n,{start:o,end:s}=t,c=lt(r,n),l=o===s?c.find(e=>o>e.start&&o<e.end):c.find(e=>o>=e.start&&s<=e.end&&o<e.contentEnd&&s>e.contentStart);if(l){let t=e.slice(l.contentStart,l.contentEnd),n=e.slice(0,l.start)+t+e.slice(l.end),r=e=>Math.min(Math.max(e-i.length,l.start),l.start+t.length);return{value:n,selection:{start:r(o),end:r(s)}}}if(o===s){let t=e.slice(0,o)+i+a+e.slice(s),n=o+i.length;return{value:t,selection:{start:n,end:n}}}let u=c.filter(e=>e.start<s&&o<e.end),d=Math.min(o,...u.map(e=>e.start)),f=Math.max(s,...u.map(e=>e.end)),p=u.flatMap(e=>[{at:e.start,len:i.length},{at:e.contentEnd,len:a.length}]).sort((e,t)=>e.at-t.at),m=``,h=d;for(let t of p)m+=e.slice(h,t.at),h=t.at+t.len;m+=e.slice(h,f);let g=e.slice(0,d)+i+m+a+e.slice(f),_=e=>{let t=0;for(let n of p)if(e>=n.at+n.len)t+=n.len;else if(e>n.at){t+=e-n.at;break}else break;return d+i.length+(e-d-t)};return{value:g,selection:{start:_(o),end:_(s)}}}function dt(e,t,n){let{start:r,end:i}=t,a=e.slice(0,r)+n+e.slice(i),o=r+n.length;return{value:a,selection:{start:o,end:o}}}var ft=class{host;schema;value;changeHandlers=new Set;rafId=null;composing=!1;onInput=()=>{this.composing||this.scheduleRerender()};onKeydown=e=>this.handleKeydown(e);onPaste=e=>this.handlePaste(e);onDrop=e=>this.handleDrop(e);onCompositionStart=()=>{this.composing=!0};onCompositionEnd=()=>{this.composing=!1,this.scheduleRerender()};onBlur=()=>{this.composing&&(this.composing=!1,this.scheduleRerender())};constructor(e,t){this.host=e,this.schema=t.schema,this.value=t.value??``,e.classList.add(`tsk-rte`),e.setAttribute(`contenteditable`,`true`),e.setAttribute(`role`,`textbox`),e.setAttribute(`aria-multiline`,`true`),e.setAttribute(`spellcheck`,`true`),t.placeholder&&(e.dataset.placeholder=t.placeholder),t.onChange&&this.changeHandlers.add(t.onChange),e.addEventListener(`input`,this.onInput),e.addEventListener(`keydown`,this.onKeydown),e.addEventListener(`paste`,this.onPaste),e.addEventListener(`drop`,this.onDrop),e.addEventListener(`compositionstart`,this.onCompositionStart),e.addEventListener(`compositionend`,this.onCompositionEnd),e.addEventListener(`blur`,this.onBlur),this.render()}getValue(){return this.rafId===null?this.value:rt(this.host)}hasPendingEdit(){return this.rafId!==null}setValue(e){if(document.activeElement===this.host&&e===this.getValue())return;let t=this.rafId!==null;this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null),!(e===this.value&&!t)&&(this.value=e,this.render())}toggleMark(e){let t=this.schema.marks.find(t=>t.name===e);t&&this.applyCommand(e=>ut(this.value,e,t,Je(this.value,this.schema)))}insertToken(e,t){this.applyCommand(n=>dt(this.value,t??n,e))}getSelection(){return ot(this.host)}focus(){this.host.focus()}on(e,t){return this.changeHandlers.add(t),()=>this.changeHandlers.delete(t)}destroy(){this.rafId!==null&&cancelAnimationFrame(this.rafId),this.host.removeEventListener(`input`,this.onInput),this.host.removeEventListener(`keydown`,this.onKeydown),this.host.removeEventListener(`paste`,this.onPaste),this.host.removeEventListener(`drop`,this.onDrop),this.host.removeEventListener(`compositionstart`,this.onCompositionStart),this.host.removeEventListener(`compositionend`,this.onCompositionEnd),this.host.removeEventListener(`blur`,this.onBlur),this.host.removeAttribute(`contenteditable`),this.changeHandlers.clear()}scheduleRerender(){this.rafId===null&&(this.rafId=requestAnimationFrame(()=>{this.rafId=null,this.rerenderFromDom()}))}rerenderFromDom(){let e=ot(this.host),t=rt(this.host),n=t!==this.value;this.value=t,this.host.innerHTML=this.renderHtml(),e&&ct(this.host,e.start,e.end),this.host.classList.toggle(`tsk-rte-empty`,this.value.length===0),n&&this.emitChange()}renderHtml(){let e=Xe(Ye(this.value,this.schema));return this.value.endsWith(`
`)&&(e+=`<br>`),e}flushPendingRerender(){this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null,this.rerenderFromDom())}applyCommand(e){this.flushPendingRerender();let t=e(ot(this.host)??{start:this.value.length,end:this.value.length}),n=t.value!==this.value;this.value=t.value,this.render(),this.focus(),ct(this.host,t.selection.start,t.selection.end),n&&this.emitChange()}render(){this.host.innerHTML=this.renderHtml(),this.host.classList.toggle(`tsk-rte-empty`,this.value.length===0)}handleKeydown(e){if(e.isComposing)return;if(e.key===`Enter`){e.preventDefault(),this.applyCommand(e=>dt(this.value,e,`
`));return}if(!(e.ctrlKey||e.metaKey)||e.altKey)return;let t=e.key.toLowerCase(),n=this.schema.marks.find(e=>e.shortcut===t);n&&(e.preventDefault(),this.toggleMark(n.name))}handlePaste(e){e.preventDefault();let t=e.clipboardData?.getData(`text/plain`)??``;t&&this.applyCommand(e=>dt(this.value,e,t))}handleDrop(e){e.preventDefault();let t=e.dataTransfer?.getData(`text/plain`)??``;if(!t)return;let n=this.caretRangeAtPoint(e.clientX,e.clientY);if(n&&this.host.contains(n.startContainer)){let e=window.getSelection();e?.removeAllRanges(),e?.addRange(n)}this.host.focus(),this.applyCommand(e=>dt(this.value,e,t))}caretRangeAtPoint(e,t){let n=document;if(typeof n.caretRangeFromPoint==`function`)return n.caretRangeFromPoint(e,t);let r=n.caretPositionFromPoint?.(e,t);if(!r)return null;let i=document.createRange();return i.setStart(r.offsetNode,r.offset),i.collapse(!0),i}emitChange(){for(let e of this.changeHandlers)e(this.value)}},pt=[{name:`bold`,open:`**`,close:`**`,tag:`strong`,shortcut:`b`},{name:`italic`,open:`*`,close:`*`,tag:`em`,shortcut:`i`},{name:`subscript`,open:`~`,close:`~`,tag:`sub`},{name:`superscript`,open:`^`,close:`^`,tag:`sup`}];function mt(e){let t=RegExp(`${C().source}|${w().source}`,`gi`),n=typeof e==`function`?e:()=>e;return{name:`figure`,pattern:t,render:e=>{let t,r=n();return r&&(t=e[1]===void 0?E((e[2]??``).trim(),r,r.displayNumToFig.size)?.displayNum:r.idToDisplayNum.get(parseInt(e[1],10))),t===void 0?{html:i(e[0]),className:`tsk-chip tsk-chip-broken`}:{html:i(`(Fig. ${t})`),className:`tsk-chip`}}}}function ht(e,t){let n=new ft(e,{schema:t.schema,value:t.value,placeholder:t.placeholder,onChange:t.onChange});return e._rte=n,t.schema.tokens.length>0&&(e.dataset.rteFigures=`true`),n}function gt(e){return e?e._rte:void 0}function _t(e,t){let n=e._rte;n&&(document.activeElement===e||n.hasPendingEdit()||n.setValue(t))}function vt(e){let t=[...e.querySelectorAll(`.rte-host`)];e.matches?.(`.rte-host`)&&t.push(e);for(let e of t){let t=e._rte;t&&(t.destroy(),delete e._rte)}}var yt=null,bt=null;function xt(e){let t=e.getFigures();return t!==yt&&(yt=t,bt=T(t)),bt}function St(e){return{marks:pt,tokens:[mt(()=>xt(e))]}}function Ct(){return{marks:pt,tokens:[]}}var wt=!1;function R(e){wt||(wt=!0,requestAnimationFrame(()=>{wt=!1,e()}))}function Tt(e){let{session:t,fieldKey:n,endTypingSession:r,applyUpdate:i,onSettle:a,refreshAll:o}=e;t.start(n,r),i(),t.extendTimeout(800,()=>{a?.(),R(o)})}async function Et(e){let t=e.getTitle();He(await A.getProjectList(),t)}function Dt(e){let{container:t,cardSelector:n,getDraggedId:r,setDraggedId:i,onDrop:a,signal:o}=e,s=null,c=null,l=null,u=0,d=()=>{s&&(s.classList.remove(`drag-drop-above`,`drag-drop-below`),s=null,c=null,l=null)},f=(e,r)=>{let i=r.closest(n);if(!i){d();return}let a=t.scrollTop;(s!==i||!l||u!==a)&&(l=i.getBoundingClientRect(),u=a);let o=e-l.top<l.height/2?`drag-drop-above`:`drag-drop-below`;if(s!==i||c!==o){let e=l;d(),i.classList.add(o),s=i,c=o,l=e}};t.addEventListener(`dragstart`,e=>{let t=e.target.closest(n);t&&(i(Number(t.getAttribute(`data-id`))),requestAnimationFrame(()=>{t.style.opacity=`0.4`}))},{signal:o}),t.addEventListener(`dragend`,e=>{let t=e.target.closest(n);t&&(t.style.opacity=`1`),i(null),d()},{signal:o}),t.addEventListener(`dragover`,e=>{if(r()===null)return;e.preventDefault();let n=t.getBoundingClientRect();e.clientY-n.top<80?t.scrollBy(0,-15):n.bottom-e.clientY<80&&t.scrollBy(0,15),f(e.clientY,e.target)},{signal:o}),t.addEventListener(`dragleave`,e=>{let n=e.relatedTarget;(!n||!t.contains(n))&&d()},{signal:o}),t.addEventListener(`drop`,e=>{e.preventDefault();let t=e.target.closest(n);if(!t)return;let i=r(),o=Number(t.getAttribute(`data-id`));i===null||i===o||a(i,o,t.classList.contains(`drag-drop-above`)?`above`:`below`)},{signal:o})}var Ot=null;function kt(){Ot?.()}function At(e){kt();let t=document.createElement(`div`);t.className=`popover`,t.setAttribute(`role`,`menu`);let n=e.items.map((e,t)=>`<button type="button" class="popover-action ${e.className??``}" data-item-index="${t}">${i(e.label)}</button>`).join(``);t.innerHTML=(e.headerHtml??``)+n,document.body.appendChild(t);let r=t.getBoundingClientRect(),a=Math.max(8,Math.min(e.x,window.innerWidth-r.width-8)),o=Math.max(8,Math.min(e.y,window.innerHeight-r.height-8));t.style.left=`${a}px`,t.style.top=`${o}px`;let s=new AbortController,{signal:c}=s,l=()=>{s.abort(),t.remove(),Ot===l&&(Ot=null),e.onClose?.()};return Ot=l,document.addEventListener(`mousedown`,e=>{t.contains(e.target)||l()},{signal:c}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&(e.preventDefault(),l())},{signal:c}),window.addEventListener(`scroll`,l,{signal:c,capture:!0}),window.addEventListener(`resize`,l,{signal:c}),e.signal.addEventListener(`abort`,l,{signal:c}),t.addEventListener(`click`,t=>{let n=t.target,r=n.closest(`[data-step-id]`);if(r&&e.onCrumbSelect){let t=Number(r.getAttribute(`data-step-id`));l(),e.onCrumbSelect(t);return}let i=n.closest(`[data-item-index]`);if(i){let t=Number(i.getAttribute(`data-item-index`)),n=e.items[t];l(),n?.onSelect()}},{signal:c}),l}var jt=new Map(pt.map(e=>[e.name,e.tag]));function Mt(e,t){let n=jt.get(e);return n?`<${n}>${t}</${n}>`:t}function z(e,t){let n=``;for(let r of e)r.kind===`text`?n+=t.text(r.value):r.kind===`fig`?n+=t.fig(r):r.kind===`brokenFig`?n+=t.brokenFig(r):n+=t.mark(r.markName,z(r.children,t));return n}function Nt(){return{name:`figure`,pattern:RegExp(`${C().source}|${w().source}`,`gi`),render:()=>({html:``,className:``})}}function Pt(e,t,n){let r=/\[figID:\s*(\d+)\s*\]/i.exec(e);if(r){let e=parseInt(r[1],10),n=t.idToDisplayNum.get(e);return n===void 0?{kind:`brokenFig`,label:`ID ${e}`}:{kind:`fig`,figId:e,displayNum:n}}let i=(/\[fig:\s*([^\]]+?)\s*\]/i.exec(e)?.[1]??``).trim(),a=E(i,t,n);return a?{kind:`fig`,figId:a.figId,displayNum:a.displayNum}:{kind:`brokenFig`,label:i}}function Ft(e,t,n){let r=[];for(let i of e)i.kind===`text`?r.push({kind:`text`,value:i.value}):i.kind===`mark`?r.push({kind:`mark`,markName:i.mark.name,children:Ft(i.children,t,n)}):r.push(Pt(i.src,t,n));return r}function It(e,t,n,r){return e?Ft(Ye(e,{marks:pt,tokens:r?[Nt()]:[]}),t,n):[]}function Lt(e,t){let n=t!==void 0;return It(e,T(n?t:[]),t?.length??0,n)}function B(e,t,n){return z(Lt(e,n),t)}var Rt={text:e=>e,fig:e=>`(Fig. ${e.displayNum})`,brokenFig:e=>`[Broken Fig: ${e.label}]`,mark:(e,t)=>t};function zt(e,t){return B(e,Rt,t)}function Bt(e,t){let n=e.scientificName.trim(),r=e.vernacularName.trim(),i={name:n,isScientific:!0,auctor:e.auctor.trim()},a={name:r,isScientific:!1,auctor:``};return t===`vernacular`&&r?{heading:a,secondary:n?{...i,label:`Scientific name`}:null}:n?{heading:i,secondary:r?{...a,label:`Vernacular name`}:null}:{heading:r?a:{name:`Untitled taxon`,isScientific:!1,auctor:``},secondary:null}}function Vt(e,t){let n=e.getKey(),r=e.getFigures(),i=e.getTaxa(),a=u(n),o=T(r),s=r.length,c=t.showBackReference?v(n):null,l=p(i,t.nameMode),d=n.map((e,n)=>{let r=n+1,{lead1:i,lead2:u}=y(t.leadFormat,r,c?.get(e.id));return{id:e.id,displayNum:r,lead1:i,lead2:u,alt1:It(e.alt1,o,s,!0),alt2:It(e.alt2,o,s,!0),dest1:h(e.branch1,a,l),dest2:h(e.branch2,a,l)}});return{title:e.getTitle(),isEmpty:n.length===0,couplets:d,taxa:i,figures:r}}function Ht(e){e.classList.remove(`nav-flash`),e.offsetWidth,e.classList.add(`nav-flash`);let t=()=>e.classList.remove(`nav-flash`);e.addEventListener(`animationend`,t,{once:!0}),window.setTimeout(t,1200)}function Ut(e){let t=document.querySelector(e);return t?(t.scrollIntoView({behavior:`smooth`,block:`center`}),Ht(t),!0):!1}function Wt(e,t){for(let n of[w(),C()]){let r;for(;(r=n.exec(e))!==null;){let e=r.index,n=r.index+r[0].length;if(t>=e&&t<=n)return{start:e,end:n,value:r[1].trim()}}}return null}function Gt(e){return Ut(`.key-card[data-id="${e}"]`)}function Kt(e,t){let{displayNumToFig:n,filenameToFig:r}=T(t.getFigures()),i=parseInt(e,10);return!isNaN(i)&&String(i)===e?n.get(i)?.id??null:r.get(e.toLowerCase())?.id??null}async function qt(e,t,n,r,a,o){if(!n.isFiguresHidden&&Ut(`.figure-card[data-id="${e}"]`))return;let s=t.getFigures(),c=s.findIndex(t=>t.id===e);if(c===-1)return;let l=s[c],u=c+1,d=j.get(e)??null,f=null;if(!d){let n=await A.getFigureBinary(t.getActiveProjectUid(),e);n&&(d=URL.createObjectURL(n),f=d)}At({x:r,y:a,headerHtml:`<div class="popover-fig-title">Fig. ${u}</div>${d?`<img class="popover-fig-img" src="${d}" alt="${i(l.filename||`Figure ${u}`)}" />`:`<div class="popover-note">No image uploaded for this figure.</div>`}<div class="popover-fig-caption">${i(l.caption||l.filename||`Untitled figure`)}</div>`,items:[],signal:o,onClose:()=>{f&&URL.revokeObjectURL(f)}})}function Jt(e,n,r){document.addEventListener(`click`,i=>{if(!(i.ctrlKey||i.metaKey))return;let a=i.target,o=()=>{i.preventDefault(),i.stopPropagation()},s=a.closest(`.badge-link[data-step-id]`);if(s){o(),Gt(Number(s.getAttribute(`data-step-id`)));return}let c=a.closest(`.fig-ref[data-fig-id]`);if(c){o(),qt(Number(c.getAttribute(`data-fig-id`)),e,n,i.clientX,i.clientY,r);return}let l=t=>t?e.getKey().find(e=>e.id===Number(t.getAttribute(`data-id`))):void 0,u=a.closest(`.input-destination`);if(u){let e=l(u.closest(`.key-card`)),n=e&&(u.dataset.field===`dest1`?e.branch1:e.branch2),r=n?t(n):null;r!==null&&(o(),Gt(r));return}let d=a.closest(`.print-dest`);if(d){let e=d.closest(`.print-row`),n=l(d.closest(`.print-step-block`)),r=n&&e&&(e.getAttribute(`data-choice`)===`1`?n.branch1:n.branch2),i=r?t(r):null;i!==null&&(o(),Gt(i));return}let f=a.closest(`.rte-host .tsk-chip[data-src]`);if(f){let t=Wt(f.getAttribute(`data-src`)??``,0),a=t?Kt(t.value,e):null;a!==null&&(o(),qt(a,e,n,i.clientX,i.clientY,r))}},{signal:r,capture:!0})}function Yt(e,t,n){document.addEventListener(`contextmenu`,r=>{let a=r.target;if(a.closest(`input, textarea, .rte-host`))return;let o=a.closest(`.key-card`)||a.closest(`.print-step-block`);if(!o)return;let s=Number(o.getAttribute(`data-id`));if(!Number.isFinite(s))return;r.preventDefault();let c=e.getKey(),l=Ae(c,s),d=(u(c).get(s)??0)+1,f;f=l.reachable?`<div class="popover-path">${l.steps.map(t=>{let n=`${t.stepNum}${t.choice??``}`;if(t.choice===void 0)return`<div class="popover-path-row is-target"><span class="popover-path-num">${n}</span><span class="popover-path-text">(this step)</span></div>`;let r=c.find(e=>e.id===t.id),a=zt(r?t.choice===`a`?r.alt1:r.alt2:``,e.getFigures()).trim()||`(no description)`;return`<button type="button" class="popover-path-row" data-step-id="${t.id}"><span class="popover-path-num">${i(n)}</span><span class="popover-path-text">${i(a)}</span></button>`}).join(``)}</div>`:`<div class="popover-note">Step ${d} is unreachable from step 1.</div>`;let p=[{label:`Go to step ${d}`,onSelect:()=>Gt(s)}];l.reachable&&l.steps.length>1&&p.push({label:`Select whole path`,onSelect:()=>{e.setSelectionBatch(l.steps.map(e=>e.id)),R(t)}}),At({x:r.clientX,y:r.clientY,headerHtml:f,items:p,onCrumbSelect:e=>Gt(e),signal:n})},{signal:n})}var Xt=null;function Zt(e,t,n){let r=document.getElementById(`key-title-input`);if(!r)return;let i=!1,a=async()=>{if(!i){i=!0;try{e.endTypingSession();let n=r.value.trim();if(!n){r.value=e.getTitle();return}let i=e.getPersistedTitle().toLowerCase();if((await A.getProjectList()).some(e=>{let t=e.name.toLowerCase();return t===n.toLowerCase()&&t!==i})){I(`⚠️ A project named "${n}" already exists. Reverted the title.`,`error`),r.value=e.getTitle();return}e.setTitle(n),R(t)}finally{i=!1}}};r.addEventListener(`blur`,a,{signal:n}),r.addEventListener(`keydown`,t=>{t.key===`Enter`?(t.preventDefault(),a(),r.blur()):t.key===`Escape`&&(t.preventDefault(),r.value=e.getTitle(),r.blur())},{signal:n})}function Qt(e,t,n){let r=e.getKey().find(e=>e.id===t);if(!r)return;let i=e.encodeFigureTokens(r[n]);i!==r[n]&&e.updateCouplet(t,{[n]:i})}function $t(e,t,n,r,i,a){e.setActiveCouplet(r),Tt({session:t.typing.couplets,fieldKey:`${r}-${i}`,endTypingSession:()=>e.endTypingSession(),applyUpdate:()=>e.updateCouplet(r,{[i]:a}),onSettle:()=>Qt(e,r,i),refreshAll:n})}function en(e,t,n,r){e.addEventListener(`click`,e=>{let r=e.target,i=r.closest(`.btn-create-taxon`);if(i){let e=i.closest(`.key-card`),r=i.getAttribute(`data-for`);if(e&&(r===`dest1`||r===`dest2`)){let a=Number(e.getAttribute(`data-id`)),o=r===`dest1`?`branch1`:`branch2`,s=i.getAttribute(`data-name-field`)===`vernacular`?`vernacular`:`scientific`,c=t.createTaxonForBranch(a,o,s);if(n(),c!==null){let e=`.taxon-card[data-id="${c}"]`;Ut(e);let t=s===`vernacular`?`vernacularName`:`scientificName`;document.querySelector(`${e} input[data-field="${t}"]`)?.focus()}}return}if(r.id===`editor-container`){t.clearSelection(),R(n);return}if(r.closest(`input, textarea, .rte-host`))return;let a=r.closest(`.key-card`);if(!a)return;let o=Number(a.getAttribute(`data-id`)),s=e.ctrlKey||e.metaKey||e.shiftKey;t.toggleSelection(o,s),R(n)},{signal:r})}function tn(e,t,n,r,i){e.addEventListener(`input`,e=>{let i=e.target;if(!i.classList.contains(`input-sync`))return;let a=i.closest(`.key-card`);if(!a)return;let o=i.getAttribute(`data-field`);if(o!==`dest1`&&o!==`dest2`)return;let s=Number(a.getAttribute(`data-id`)),c=`${s}-${o}`;t.setActiveCouplet(s),n.typing.couplets.start(c,()=>{t.endTypingSession()});let l=o===`dest1`?`branch1`:`branch2`,d=b(i.value,t.getKey());if(d.kind===`taxonDraft`){let e=ge(t.getTaxa(),d.name);e&&(d={kind:`taxon`,taxonId:e.id})}t.updateCouplet(s,{[l]:d}),n.typing.couplets.extendTimeout(800,()=>{let e=t.getKey(),a=e.find(e=>e.id===s);if(a){let r=u(e),o=p(t.getTaxa(),n.nameDisplayMode),s=h(a[l],r,o);i.classList.toggle(`input-error`,s.isUnresolved)}R(r)})},{signal:i})}function nn(e,t,n,r,i){e.addEventListener(`focusin`,e=>{let n=e.target;if(n.matches(`input, textarea, .rte-host`)){let e=n.closest(`.key-card`);if(!e)return;e.draggable=!1;let i=Number(e.getAttribute(`data-id`));t.setActiveCouplet(i),i!==Xt&&(Xt=i,R(r)),n.classList.contains(`input-destination`)&&n instanceof HTMLInputElement&&queueMicrotask(()=>{document.activeElement===n&&n.select()})}},{signal:i}),e.addEventListener(`focusout`,e=>{let i=e.target;if(i.matches(`input, textarea, .rte-host`)){let a=i.closest(`.key-card`);a&&(a.draggable=!0);let o=a?Number(a.getAttribute(`data-id`)):null,s=i.getAttribute(`data-field`),c=o&&s?`${o}-${s}`:null;n.typing.couplets.end(c,()=>{t.clearActiveCouplet(),(s===`alt1`||s===`alt2`)&&o!==null&&Qt(t,o,s);let n=e.relatedTarget,i=n instanceof Element&&n.closest(`.key-card`),a=i||n instanceof Element&&(n.closest(`.app-menu-bar`)||n.closest(`#add-couplet-btn`));i||(Xt=null),a||R(r)})}},{signal:i})}function rn(e,t,n,r){Dt({container:e,cardSelector:`.key-card`,getDraggedId:()=>t.draggedCoupletId,setDraggedId:e=>e===null?t.stopDraggingCouplet():t.startDraggingCouplet(e),signal:r,onDrop:(e,r,i)=>{t.reorderCouplets(e,r,i),R(n)}})}function an(e,t){let n=e.addCouplet();t(),(document.querySelector(`.key-card[data-id="${n}"]`)?.querySelector(`.rte-host[data-field="alt1"]`))?.focus()}function on(e,t,n){let r,i=e.getSelectedCoupletIds(),a=e.getKey(),o=a.filter(e=>i.has(e.id));o.length>0?r=n===`below`?o[o.length-1].id:o[0].id:a.length>0&&(r=n===`above`?a[0].id:a[a.length-1].id),e.pasteCouplets(r,n)&&(I(`Pasted steps ${o.length>0?`${n} selection`:n===`above`?`at the beginning`:`at the end`}.`,`success`),R(t))}var sn={alt1:`Enter diagnostic trait details [fig: 1]...`,alt2:`Enter contrast alternative description...`};function cn(e,t,n,r,i){[`alt1`,`alt2`].forEach(a=>{let o=e.querySelector(`.rte-host[data-field="${a}"]`);o&&ht(o,{schema:St(n),value:n.decodeTextReferencesForEditor(t[a]),placeholder:sn[a],onChange:e=>$t(n,r,i,t.id,a,e)})})}function ln(e,t,n){let r=e.querySelector(`.create-taxon-group[data-for="${t}"]`);r&&(r.hidden=!n)}function un(e){return`
        ...
        </div>`}function dn(e){let t=document.createElement(`div`);return t.className=`key-card`,t.draggable=!0,t.setAttribute(`data-id`,e.id.toString()),t.innerHTML=`
    ...
    `,t}function fn(e,n,r){let a=document.getElementById(`editor-container`);if(!a)return;let o=e.getKey(),s=e.getSelectedCoupletIds(),c=e.runDiagnostics(),l=u(o),d=e.generateInboundLinksMap(),f=p(e.getTaxa(),n.nameDisplayMode),m=s.size===1?[...s][0]:s.size===0?e.getActiveCoupletId():null,g=new Set,_=new Set;if(m!==null){let e=o.find(e=>e.id===m);if(e){let n=t(e.branch1);n!==null&&g.add(n);let r=t(e.branch2);r!==null&&g.add(r)}o.forEach(e=>{(t(e.branch1)===m||t(e.branch2)===m)&&_.add(e.id)})}Be({container:a,items:o,getId:e=>e.id,create:t=>{let i=dn(t);return cn(i,t,e,n,r),i},update:(t,n,r)=>{let a=r+1,u=d.get(n.id)||[],p=h(n.branch1,l,f),v=h(n.branch2,l,f),y=c.get(n.id)||[],b=`${a}.`,x=u.length||r===0?`badge badge-linked`:`badge badge-isolated`,S=u.length?`← ${u.map(e=>{let t=o[parseInt(e,10)-1]?.id;return t===void 0?i(e):`<span class="badge-link" data-step-id="${t}">${i(e)}</span>`}).join(`, `)}`:r===0?`🏁 root`:`⚠️ isolated`,C=``;y.forEach(e=>{let t=e.severity===`error`?`error-text`:`warning-text`;C+=`<div class="${t}">⚠️ ${i(e.message)}</div>`}),t.classList.toggle(`is-selected`,s.has(n.id)),t.classList.toggle(`is-link-out`,n.id!==m&&g.has(n.id)),t.classList.toggle(`is-link-in`,n.id!==m&&_.has(n.id));let w=t.querySelector(`.card-title`);w&&w.textContent!==b&&(w.textContent=b);let T=t.querySelector(`.badge`);T&&(T.className!==x&&(T.className=x),T.innerHTML!==S&&(T.innerHTML=S));let E=t.querySelector(`.rte-host[data-field="alt1"]`);E&&(E.setAttribute(`aria-label`,`Step ${a}, first alternative description`),_t(E,e.decodeTextReferencesForEditor(n.alt1)));let D=F(t,`input[data-field="dest1"]`,p.inputValue);D?.setAttribute(`aria-label`,`Step ${a}, first alternative destination`),D?.classList.toggle(`input-error`,p.isUnresolved),D?.classList.toggle(`input-taxon-unlinked`,!!p.isUnlinkedTaxon),ln(t,`dest1`,p.isUnlinkedTaxon);let O=t.querySelector(`.rte-host[data-field="alt2"]`);O&&(O.setAttribute(`aria-label`,`Step ${a}, second alternative description`),_t(O,e.decodeTextReferencesForEditor(n.alt2)));let k=F(t,`input[data-field="dest2"]`,v.inputValue);k?.setAttribute(`aria-label`,`Step ${a}, second alternative destination`),k?.classList.toggle(`input-error`,v.isUnresolved),k?.classList.toggle(`input-taxon-unlinked`,!!v.isUnlinkedTaxon),ln(t,`dest2`,v.isUnlinkedTaxon);let A=t.querySelector(`.warning-block`);y.length>0?A?A.innerHTML!==C&&(A.innerHTML=C):t.insertAdjacentHTML(`beforeend`,`<div class="warning-block">${C}</div>`):A&&A.remove()},onRemove:vt})}function pn(e,t,n){return n===`below`?e<t?t:t+1:e<t?t-1:t}function mn(e){let{container:t,cardSelector:n,addButton:r,fieldKeyPrefix:i,typing:a,signal:o,refreshAll:s,onAdd:c,endTypingSession:l,buildUpdate:u,applyUpdate:d,toggleSelection:f,clearSelection:p,getItems:m,reorder:h,onSettle:g,settleField:_,extraClick:v,keepFocusWithin:y=[]}=e;r?.addEventListener(`click`,()=>{c(),R(s)},{signal:o}),t.addEventListener(`input`,e=>{let t=e.target;if(!t.classList.contains(`input-sync`))return;let r=t.closest(n);if(!r)return;let o=Number(r.getAttribute(`data-id`)),c=t.getAttribute(`data-field`),f=`${i}-${o}-${c}`;a.start(f,l);let p=u(c,t.value);p&&d(o,p),a.extendTimeout(800,()=>{g?.(),R(s)})},{signal:o}),t.addEventListener(`click`,e=>{let r=e.target;if(v?.(r,e))return;if(r===t){p(),R(s);return}let i=r.closest(n);if(!i)return;let a=Number(i.getAttribute(`data-id`)),o=e.ctrlKey||e.metaKey||e.shiftKey;if(r.closest(`input, textarea, .rte-host`)){i.classList.contains(`is-selected`)||(f(a,o),R(s));return}f(a,o),R(s)},{signal:o}),t.addEventListener(`focusin`,e=>{let t=e.target;if(!t.matches(`input, textarea, .rte-host`))return;let r=t.closest(n);r&&(r.draggable=!1)},{signal:o}),t.addEventListener(`focusout`,e=>{let t=e.target;if(!t.matches(`input, textarea, .rte-host`))return;let r=t.closest(n);if(!r)return;r.draggable=!0;let o=Number(r.getAttribute(`data-id`)),c=t.getAttribute(`data-field`),l=o&&c?`${i}-${o}-${c}`:null;a.end(l,()=>{c&&_?.(o,c);let t=g?.()??!1,r=e.relatedTarget,i=[n,`.app-menu-bar`,...y],a=r instanceof Element&&i.some(e=>r.closest(e));(t||!a)&&R(s)})},{signal:o});let b=null;Dt({container:t,cardSelector:n,getDraggedId:()=>b,setDraggedId:e=>{b=e},signal:o,onDrop:(e,t,n)=>{let r=m(),i=r.findIndex(t=>t.id===e),a=r.findIndex(e=>e.id===t);if(i===-1||a===-1)return;let o=pn(i,a,n);i!==o&&(h(i,o),R(s))}})}var V=null,H,hn,gn,U=1,W=0,G=0,_n=``,vn=null,K=1,yn=8,bn=(e,t,n)=>Math.min(n,Math.max(t,e));function xn(){let e=H.parentElement,t=Math.max(0,(H.offsetWidth*U-e.clientWidth)/2),n=Math.max(0,(H.offsetHeight*U-e.clientHeight)/2);W=bn(W,-t,t),G=bn(G,-n,n)}function Sn(){U<K&&(U=K),xn(),H.style.transform=`translate(${W}px, ${G}px) scale(${U})`,H.style.cursor=U>K?`grab`:`default`,gn.textContent=`${Math.round(U*100)}%`}function Cn(){U=1,W=0,G=0,Sn()}function wn(e,t,n){let r=H.parentElement.getBoundingClientRect(),i=e-(r.left+r.width/2),a=t-(r.top+r.height/2),o=bn(U*n,K,yn),s=o/U;W=i*(1-s)+W*s,G=a*(1-s)+G*s,U=o,Sn()}function Tn(){!V||V.style.display===`none`||(V.style.display=`none`,H.removeAttribute(`src`),document.body.style.overflow=_n,vn?.focus?.(),vn=null)}function En(){if(V)return;document.getElementById(`image-lightbox`)?.remove(),V=document.createElement(`div`),V.id=`image-lightbox`,V.className=`image-lightbox-overlay`,V.setAttribute(`role`,`dialog`),V.setAttribute(`aria-modal`,`true`),V.style.display=`none`,V.innerHTML=`
        ...
        </div>`,document.body.appendChild(V),H=V.querySelector(`.image-lightbox-img`),hn=V.querySelector(`.image-lightbox-caption`),gn=V.querySelector(`.image-lightbox-zoom`);let e=V.querySelector(`.image-lightbox-stage`);V.querySelector(`.image-lightbox-toolbar`).addEventListener(`click`,t=>{let n=t.target.closest(`button`)?.dataset.act;if(!n)return;let r=e.getBoundingClientRect(),i=r.left+r.width/2,a=r.top+r.height/2;n===`in`?wn(i,a,1.3):n===`out`?wn(i,a,1/1.3):n===`reset`?Cn():n===`close`&&Tn()}),e.addEventListener(`wheel`,e=>{e.preventDefault(),wn(e.clientX,e.clientY,e.deltaY<0?1.15:1/1.15)},{passive:!1}),e.addEventListener(`click`,t=>{t.target===e&&Tn()}),H.addEventListener(`dblclick`,e=>{U>K?Cn():wn(e.clientX,e.clientY,2.5)});let t=!1,n=0,r=0;H.addEventListener(`pointerdown`,e=>{U<=K||(t=!0,n=e.clientX,r=e.clientY,H.setPointerCapture(e.pointerId),H.style.cursor=`grabbing`)}),H.addEventListener(`pointermove`,e=>{t&&(W+=e.clientX-n,G+=e.clientY-r,n=e.clientX,r=e.clientY,Sn())});let i=e=>{if(t){t=!1;try{H.releasePointerCapture(e.pointerId)}catch{}H.style.cursor=U>K?`grab`:`default`}};H.addEventListener(`pointerup`,i),H.addEventListener(`pointercancel`,i),document.addEventListener(`keydown`,e=>{V&&V.style.display!==`none`&&e.key===`Escape`&&(e.stopPropagation(),Tn())})}function Dn(e,t=``){En(),V.style.display===`none`&&(_n=document.body.style.overflow,document.body.style.overflow=`hidden`,vn=document.activeElement),V.setAttribute(`aria-label`,t||`Figure image viewer`),hn.textContent=t,H.src=e,Cn(),V.style.display=`flex`,V.querySelector(`.image-lightbox-close`)?.focus()}var On=null;function kn(e){return e instanceof HTMLElement&&e.classList.contains(`rte-host`)&&e.dataset.rteFigures===`true`}function An(){let e=document.activeElement;if(kn(e)){let t=gt(e);if(t)return{editor:t,selection:t.getSelection()}}if(On&&document.body.contains(On.host)){let e=gt(On.host);if(e)return{editor:e,selection:On.selection}}return null}function jn(e,t,n,r){let i=An();if(!i){I(`Click into a key step or taxon description first, then insert a figure reference.`,`error`);return}let a=e.getFigures();if(a.length===0){I(`Add a figure in the Figures panel first, then insert a reference.`,`error`);return}At({x:t,y:n,signal:r,headerHtml:`<div class="popover-header">Insert figure reference</div>`,items:a.map((e,t)=>{let n=t+1,r=e.caption||e.filename||``;return{label:r?`Fig. ${n} — ${r}`:`Fig. ${n}`,onSelect:()=>i.editor.insertToken(`[fig: ${n}]`,i.selection??void 0)}})})}function Mn(e,t,n,r){let i=document.getElementById(`figure-container`);i&&(mn({container:i,cardSelector:`.figure-card`,addButton:document.getElementById(`add-figure-btn`),fieldKeyPrefix:`fig`,typing:t.typing.figures,signal:r,refreshAll:n,onAdd:()=>e.addFigure(``,``),endTypingSession:()=>e.endTypingSession(),buildUpdate:(e,t)=>({[e]:t}),applyUpdate:(t,n)=>e.updateFigure(t,n),toggleSelection:(t,n)=>e.toggleFigureSelection(t,n),clearSelection:()=>e.clearFigureSelection(),getItems:()=>e.getFigures(),reorder:(t,n)=>e.reorderFigures(t,n),extraClick:(t,r)=>{if(t.classList.contains(`btn-trigger-upload`))return(t.closest(`.figure-card`)?.querySelector(`.hidden-file-picker`))?.click(),!0;if(t.classList.contains(`btn-remove-image`)){let r=t.closest(`.figure-card`);if(!r)return!0;let i=Number(r.getAttribute(`data-id`));e.updateFigure(i,{filename:``}),A.deleteFigureBinary(i);let a=j.get(i);return a&&URL.revokeObjectURL(a),j.delete(i),R(n),!0}if(t.classList.contains(`figure-preview-img`)&&!(r.ctrlKey||r.metaKey||r.shiftKey)){let e=t,n=e.currentSrc||e.getAttribute(`src`)||``;if(e.style.display!==`none`&&n){let t=e.closest(`.figure-card`),r=t?.querySelector(`.figure-card-title`)?.textContent?.trim()??``,i=t?.querySelector(`.figure-input-caption`);return Dn(n,[r,zt((i?gt(i)?.getValue():``)??``)].filter(Boolean).join(`  `)),!0}}return!1},keepFocusWithin:[`.key-card`,`#add-figure-btn`,`.format-toolbar`]}),i.addEventListener(`change`,async t=>{let r=t.target;if(!r.classList.contains(`hidden-file-picker`))return;let i=r.files?.[0];if(!i)return;if(!i.type.startsWith(`image/`)){I(`⚠️ Only image files are supported.`,`error`),r.value=``;return}let a=r.closest(`.figure-card`),o=Number(a?.getAttribute(`data-id`));if(isNaN(o))return;e.updateFigure(o,{filename:i.name}),A.uploadFigureBinary(o,i);let s=j.get(o);s&&URL.revokeObjectURL(s);let c=URL.createObjectURL(i);j.set(o,c),r.value=``,R(n)},{signal:r}))}function Nn(e,t,n,r,i){Tt({session:t.typing.figures,fieldKey:`fig-${r}-caption`,endTypingSession:()=>e.endTypingSession(),applyUpdate:()=>e.updateFigure(r,{caption:i}),refreshAll:n})}function Pn(e,t){let n=e=>{let t=e.target instanceof HTMLElement?e.target.closest(`.rte-host`):null;t&&kn(t)&&(On={host:t,selection:gt(t)?.getSelection()??null})};[`focusin`,`keyup`,`mouseup`,`input`].forEach(e=>document.addEventListener(e,n,{signal:t})),document.querySelector(`#cmd-insert-figref`)?.addEventListener(`click`,n=>{let r=n.currentTarget.getBoundingClientRect();jn(e,r.left,r.bottom+4,t)},{signal:t})}var Fn=null;function In(e,t,n,r){let i=document.createElement(`div`);i.className=`figure-card`,i.setAttribute(`data-id`,e.id.toString()),i.draggable=!0,i.innerHTML=`
    ...
    `;let a=i.querySelector(`.rte-host[data-field="caption"]`);return a&&ht(a,{schema:Ct(),value:e.caption,placeholder:`Caption — supports **bold**, *italic*…`,onChange:i=>Nn(t,n,r,e.id,i)}),i}function Ln(e,t,n){if(t.isFiguresHidden)return;let r=document.getElementById(`figure-container`);if(!r)return;let i=e.getFigures();Be({container:r,items:i,getId:e=>e.id,create:r=>In(r,e,t,n),onRemove:vt,update:(r,i,a)=>{let o=a+1,s=r.querySelector(`.figure-card-title`);s&&(s.textContent=`${o}.`),r.querySelector(`.btn-trigger-upload`)?.setAttribute(`aria-label`,`Choose image for Figure ${o}`),r.querySelector(`.btn-remove-image`)?.setAttribute(`aria-label`,`Remove image for Figure ${o}`),r.querySelector(`.figure-input-filename`)?.setAttribute(`aria-label`,`Figure ${o} filename`),r.querySelector(`.rte-host[data-field="caption"]`)?.setAttribute(`aria-label`,`Figure ${o} caption`),r.classList.toggle(`is-selected`,e.getSelectedFigureIds().has(i.id));let c=r.querySelector(`.figure-preview-wrapper`),l=r.querySelector(`.figure-preview-img`);if(t.isImagesHidden)c&&(c.style.display=`none`),l&&(l.style.display=`none`);else{c&&(c.style.display=``);let t=j.get(i.id),a=r.querySelector(`.btn-remove-image`);if(t)l.src!==t&&(l.src=t),l.style.display=`block`,a&&(a.style.display=`inline-block`);else if(!l.hasAttribute(`data-loading-state`)){l.setAttribute(`data-loading-state`,`pending`);let t=e.getActiveProjectUid();A.getFigureBinary(t,i.id).then(r=>{if(l.removeAttribute(`data-loading-state`),e.getActiveProjectUid()!==t)return;let o=j.get(i.id);if(o){l.src!==o&&(l.src=o),l.style.display=`block`,a&&(a.style.display=`inline-block`);return}if(r){let e=URL.createObjectURL(r);j.set(i.id,e),Fn===null&&(Fn=requestAnimationFrame(()=>{Fn=null,n()}))}else l.style.display=`none`,a&&(a.style.display=`none`)}).catch(e=>{console.error(`Failed to load binary thumbnail:`,e),l.removeAttribute(`data-loading-state`),a&&(a.style.display=`none`)})}}let u=r.querySelector(`.figure-input-filename`);u&&document.activeElement!==u&&u.value!==i.filename&&(u.value=i.filename);let d=r.querySelector(`.rte-host[data-field="caption"]`);d&&_t(d,i.caption)}});let a=new Set(i.map(e=>e.id));for(let[e,t]of j.entries())a.has(e)||(URL.revokeObjectURL(t),j.delete(e))}var Rn=new Set([`scientificName`,`auctor`,`vernacularName`,`description`,`biology`,`distribution`]);function zn(e,t){let n=e.getTaxa().find(e=>e.id===t);if(!n)return;let r=e.encodeFigureTokens(n.description);r!==n.description&&e.updateTaxon(t,{description:r})}function Bn(e,t,n,r,i,a){Tt({session:t.typing.taxa,fieldKey:`taxon-${r}-${i}`,endTypingSession:()=>e.endTypingSession(),applyUpdate:()=>e.updateTaxon(r,{[i]:a}),onSettle:()=>{zn(e,r),e.relinkTaxonDrafts()},refreshAll:n})}function Vn(e){return e.split(`
`).map(e=>e.trim()).filter(e=>e!==``)}function Hn(e){return e.split(`
`).map(e=>{let t=e.indexOf(`|`);return{name:(t===-1?e:e.slice(0,t)).trim(),distinction:t===-1?``:e.slice(t+1).trim()}}).filter(e=>e.name!==``||e.distinction!==``)}function Un(e,t){return Rn.has(e)?{[e]:t}:e===`synonyms`?{synonyms:Vn(t)}:e===`confusables`?{confusables:Hn(t)}:null}function Wn(e,t,n,r){let i=document.getElementById(`taxa-container`);i&&mn({container:i,cardSelector:`.taxon-card`,addButton:document.getElementById(`add-taxon-btn`),fieldKeyPrefix:`taxon`,typing:t.typing.taxa,signal:r,refreshAll:n,onAdd:()=>e.addTaxon(``),endTypingSession:()=>e.endTypingSession(),buildUpdate:Un,applyUpdate:(t,n)=>e.updateTaxon(t,n),toggleSelection:(t,n)=>e.toggleTaxonSelection(t,n),clearSelection:()=>e.clearTaxonSelection(),getItems:()=>e.getTaxa(),reorder:(t,n)=>e.reorderTaxa(t,n),onSettle:()=>e.relinkTaxonDrafts(),settleField:(t,n)=>{n===`description`&&zn(e,t)},keepFocusWithin:[`#add-taxon-btn`,`.format-toolbar`]})}function Gn(e){return e.join(`
`)}function Kn(e){return e.map(e=>e.distinction?`${e.name} | ${e.distinction}`:e.name).join(`
`)}var qn=`
        ...
        ${e===`vernacular`?Yn+qn+Jn:qn+Jn+Yn}
        <div class="taxon-field-row">
    ...
    `}function Zn(e,t,n,r){let i=e.querySelector(`.taxon-card-title`),a=`${n}.`;i&&i.textContent!==a&&(i.textContent=a),F(e,`input[data-field="scientificName"]`,t.scientificName),F(e,`input[data-field="auctor"]`,t.auctor),F(e,`input[data-field="vernacularName"]`,t.vernacularName),F(e,`textarea[data-field="synonyms"]`,Gn(t.synonyms));let o=e.querySelector(`.rte-host[data-field="description"]`);o&&_t(o,r.decodeTextReferencesForEditor(t.description)),F(e,`textarea[data-field="biology"]`,t.biology),F(e,`textarea[data-field="distribution"]`,t.distribution),F(e,`textarea[data-field="confusables"]`,Kn(t.confusables))}function Qn(e,t,n,r,i){let a=document.createElement(`div`);a.className=`taxon-card`,a.setAttribute(`data-id`,e.id.toString()),a.draggable=!0,a.innerHTML=Xn(t);let o=a.querySelector(`.rte-host[data-field="description"]`);return o&&ht(o,{schema:St(n),value:n.decodeTextReferencesForEditor(e.description),placeholder:`Diagnostic description — supports **bold**, *italic*, and [fig: 1]…`,onChange:t=>Bn(n,r,i,e.id,`description`,t)}),a}function $n(e,t,n){if(t.isTaxaHidden)return;let r=document.getElementById(`taxa-container`);if(!r)return;let i=t.nameDisplayMode;r.dataset.nameMode!==i&&(vt(r),r.replaceChildren(),r.dataset.nameMode=i);let a=e.getSelectedTaxonIds();Be({container:r,items:e.getTaxa(),getId:e=>e.id,create:r=>Qn(r,i,e,t,n),update:(t,n,r)=>{t.classList.toggle(`is-selected`,a.has(n.id)),Zn(t,n,r+1,e)},onRemove:vt})}function er(e,t){return`<span class="fig-ref" data-fig-id="${e}">(Fig. ${t})</span>`}var tr={text:i,fig:e=>er(e.figId,e.displayNum),brokenFig:e=>`<span class="error-text">[Fig: ${i(e.label)}]</span>`,mark:Mt};function nr(e){let t=document.createElement(`div`);return t.className=`print-step-block`,t.setAttribute(`data-id`,e.id.toString()),t.innerHTML=`
    ...
    `,t}function rr(e,t,n){let r=e.querySelector(`.print-row[data-choice="${t}"] .print-dest`);if(!r)return;r.textContent!==n.printText&&(r.textContent=n.printText);let i=`print-dest ${n.printClass}`.trim();r.className!==i&&(r.className=i)}function ir(e,t,n){let r=e.querySelector(`.print-row[data-choice="${t}"] .print-text`);r&&r.innerHTML!==n&&(r.innerHTML=n)}function ar(e,t){if(t.isPrintHidden)return;let n=document.getElementById(`print-view-container`);if(!n)return;let r=Vt(e,{leadFormat:t.leadFormat,showBackReference:t.showBackReference,nameMode:t.nameDisplayMode});if(n.dataset.leadFormat=t.leadFormat,r.isEmpty){n.innerHTML=`<p class="print-empty-notice">This preview updates as you build your key. Add a step in the editor to get started.</p>`;return}n.querySelector(`.print-empty-notice`)?.remove(),Be({container:n,items:r.couplets,getId:e=>e.id,create:nr,update:(e,t)=>{let n=e.querySelector(`.print-step-num`);n&&n.textContent!==t.lead1&&(n.textContent=t.lead1);let r=e.querySelector(`.print-dash`);r&&r.textContent!==t.lead2&&(r.textContent=t.lead2),ir(e,`1`,z(t.alt1,tr)||`___`),rr(e,`1`,t.dest1),ir(e,`2`,z(t.alt2,tr)||`___`),rr(e,`2`,t.dest2)}})}var or=`___`;function sr(e){switch(e){case`auto`:return`Auto-detect`;case`utf-8`:return`UTF-8`;case`utf-16le`:return`UTF-16 LE`;case`utf-16be`:return`UTF-16 BE`;case`windows-1252`:return`Windows-1252 / Latin-1`}}function cr(e){return e.length>=3&&e[0]===239&&e[1]===187&&e[2]===191?`utf-8`:e.length>=2&&e[0]===255&&e[1]===254?`utf-16le`:e.length>=2&&e[0]===254&&e[1]===255?`utf-16be`:null}function lr(e){let t=cr(e);if(t)return t;let n=Math.min(e.length,4096),r=0,i=0;for(let t=0;t<n;t++)e[t]===0&&(t%2==0?r++:i++);if(n>0&&(r+i)/n>.2)return i>r?`utf-16le`:`utf-16be`;try{return new TextDecoder(`utf-8`,{fatal:!0}).decode(e),`utf-8`}catch{return`windows-1252`}}function ur(e,t){let n=new Uint8Array(e),r=t===`auto`?lr(n):t;return{text:new TextDecoder(r).decode(e),encoding:r,autoDetected:t===`auto`}}var dr=500,q={minLeaderDots:3,useWhitespaceSeparator:!0,joinWrappedLines:!0,dehyphenate:!0,recognizeLetteredCouplets:!0,recognizeDashSecondLead:!0,recognizeBackReferences:!0,fillMissingCouplets:!0};function fr(e){let t=(e??``).replace(/\s+/g,` `).trim();return t===or?``:t}function pr(e){let t=e.findIndex(e=>e.trim().toUpperCase()===`FIGURES DATA`);return t===-1?e:e.slice(0,t).filter(e=>!/^=+$/.test(e.trim()))}function mr(e,t){let n=t.recognizeLetteredCouplets?`([a-bA-B])?`:`()?`,r=t.recognizeBackReferences?`(?:\\s*\\(\\s*\\d[\\d\\s,.–-]*\\))?`:``,i=e.match(RegExp(`^\\s*(\\d{1,4})\\s*${n}\\s*[.)]?${r}\\s+(\\S.*)$`));if(i){let e=parseInt(i[1],10),n=(i[2]||``).toLowerCase(),r=i[3];return t.recognizeLetteredCouplets&&n===`b`?{kind:`second`,coupletNum:e,rest:r}:{kind:`first`,coupletNum:e,rest:r}}if(t.recognizeDashSecondLead){let t=e.match(/^\s*[-–—]\s+(\S.*)$/);if(t)return{kind:`second`,coupletNum:null,rest:t[1]}}return null}function hr(e,t,n){let r=e.replace(/\s+$/,``),i=t.trim();return n.dehyphenate&&/[A-Za-zÀ-ÿ]-$/.test(r)?r.slice(0,-1)+i:`${r} ${i}`}function gr(e,t){let n=null,r;for(;(r=e.exec(t))!==null;)n=r;return n}function _r(e,t){let n=e.lastIndexOf(`	`);if(n!==-1)return{text:e.slice(0,n),dest:e.slice(n+1)};let r=Math.max(2,Math.floor(t.minLeaderDots)||2),i=gr(RegExp(`\\.(?:\\s?\\.){${r-1},}`,`g`),e);if(i)return{text:e.slice(0,i.index),dest:e.slice(i.index+i[0].length)};if(t.useWhitespaceSeparator){let t=gr(/\s{2,}/g,e);if(t)return{text:e.slice(0,t.index),dest:e.slice(t.index+t[0].length)}}let a=e.match(/^(.*\S)\s+(\d{1,4})\.?\s*$/);return a?{text:a[1],dest:a[2]}:{text:e,dest:``}}function vr(e){let t=e.trim();if(t===``||/^[.\s]+$/.test(t))return{linkNum:0,taxa:``};let n=t.match(/^(\d{1,4})\.?$/);return n?{linkNum:parseInt(n[1],10),taxa:``}:{linkNum:0,taxa:t}}function yr(){return{alt1:``,link1:0,taxa1:``,alt2:``,link2:0,taxa2:``}}function br(e,t,n){if(e)return n.has(e)?{kind:`linked`,targetId:e}:{kind:`unresolved`,couplet:e};let r=t.trim();return r===``?{kind:`empty`}:{kind:`taxonDraft`,name:r}}function xr(e,t={}){let n={...q,...t},r=[],i=[],a=pr((e??``).replace(/\r\n?/g,`
`).split(`
`)),o=[],s=null,c=0,l=0,u=()=>{s&&=(o.push(s),null)};for(let e of a){if(e.trim()===``)continue;let t=mr(e,n);if(t){if(u(),t.kind===`first`)c=t.coupletNum,s={num:t.coupletNum,isSecond:!1,body:t.rest};else{let n=t.coupletNum??c;if(n===0){r.push(`Ignored a second-alternative line before any numbered step: "${e.trim().slice(0,50)}"`);continue}t.coupletNum!==null&&(c=t.coupletNum),s={num:n,isSecond:!0,body:t.rest}}continue}s&&n.joinWrappedLines?s.body=hr(s.body,e,n):s&&l++}if(u(),o.length===0)return i.push(`No key steps were recognized. Each step should start with a number (e.g. "1." or "1a") or a dash for the second alternative.`),{couplets:[],figures:[],warnings:r,errors:i,stepCount:0};l>0&&r.push(`${l} wrapped line(s) were dropped because "Join wrapped lines" is off.`);let d=new Map,f=e=>{let t=d.get(e);return t||(t=yr(),d.set(e,t)),t},p=0,m=!1;for(let e of o){if(e.num>dr){r.push(`Step number ${e.num} exceeds the safety ceiling of ${dr} and was skipped.`);continue}p=Math.max(p,e.num);let{text:t,dest:i}=_r(e.body,n),{linkNum:a,taxa:o}=vr(i);a>dr&&(o=String(a),a=0,m=!0),p=Math.max(p,a);let s=f(e.num);e.isSecond?(s.alt2=fr(t),s.link2=a,s.taxa2=o):((s.alt1||s.taxa1||s.link1)&&r.push(`Couplet ${e.num} has more than one first alternative; the later one overwrote the earlier.`),s.alt1=fr(t),s.link1=a,s.taxa1=o)}if(m&&r.push(`One or more destination numbers were too large to be real step links and were kept as text.`),p=Math.min(p,dr),n.fillMissingCouplets){let e=0;for(let t=1;t<=p;t++)d.has(t)||(f(t),e++);e>0&&r.push(`Generated ${e} empty key step(s) to fill gaps so links resolve.`)}let h=[...d.keys()].sort((e,t)=>e-t),g=new Set(h),_=h.map(e=>{let t=d.get(e);return{id:e,alt1:t.alt1,alt2:t.alt2,branch1:br(t.link1,t.taxa1,g),branch2:br(t.link2,t.taxa2,g)}});return{couplets:_,figures:[],warnings:r,errors:i,stepCount:_.length}}var Sr=`plain-text-import-view`,J=null,Cr=null;function Y(e){return document.getElementById(e)}function wr(){let e=(e,t)=>{let n=Y(e);return n?n.checked:t},t=Y(`pt-opt-min-dots`),n=t&&t.value!==``?parseInt(t.value,10):q.minLeaderDots;return{minLeaderDots:Number.isFinite(n)?n:q.minLeaderDots,useWhitespaceSeparator:e(`pt-opt-ws`,q.useWhitespaceSeparator),joinWrappedLines:e(`pt-opt-join`,q.joinWrappedLines),dehyphenate:e(`pt-opt-dehyphen`,q.dehyphenate),recognizeLetteredCouplets:e(`pt-opt-lettered`,q.recognizeLetteredCouplets),recognizeDashSecondLead:e(`pt-opt-dash`,q.recognizeDashSecondLead),recognizeBackReferences:e(`pt-opt-backref`,q.recognizeBackReferences),fillMissingCouplets:e(`pt-opt-fill`,q.fillMissingCouplets)}}function Tr(){return Y(`pt-import-encoding`)?.value||`auto`}function Er(){let e=Y(Sr);e&&(e.style.display=`flex`,Y(`pt-import-source`)?.focus(),X())}function Dr(){let e=Y(Sr);e&&(e.style.display=`none`)}function Or(){let e=Y(Sr);return!!e&&e.style.display!==`none`}function X(){let e=Y(`pt-import-source`),t=Y(`pt-import-preview`),n=Y(`pt-import-status`),r=Y(`pt-import-confirm`);if(!e||!t)return;let i=e.value;if(i.trim()===``){J=null,t.innerHTML=`<div class="import-preview-empty">Paste or load a key to see a live preview here.</div>`,n&&(n.textContent=``),r&&(r.disabled=!0);return}let a=xr(i,wr());J=a;let o=a.couplets.length>0&&a.errors.length===0;r&&(r.disabled=!o),n&&(a.errors.length>0?(n.textContent=`⚠️ Could not parse`,n.className=`import-status import-status-error`):(n.textContent=`✓ ${a.stepCount} step(s)`,n.className=`import-status import-status-ok`)),t.innerHTML=kr(a)}function kr(e){let t=``;if(e.errors.length>0)return t+=`<div class="import-messages">`,e.errors.forEach(e=>{t+=`<div class="import-msg import-msg-error">⛔ ${i(e)}</div>`}),t+=`</div>`,t;e.warnings.length>0&&(t+=`<div class="import-messages">`,e.warnings.forEach(e=>{t+=`<div class="import-msg import-msg-warning">⚠️ ${i(e)}</div>`}),t+=`</div>`);let n=je(e.couplets,e.figures),r=0,a=0;if(n.forEach(e=>e.forEach(e=>{e.severity===`error`?r++:a++})),r>0||a>0){let e=[];r>0&&e.push(`${r} error${r===1?``:`s`}`),a>0&&e.push(`${a} warning${a===1?``:`s`}`),t+=`<div class="import-diagnostics-summary">🩺 Key check: ${e.join(`, `)}. Fixable after import in the editor.</div>`}let o=new Map;e.couplets.forEach((e,t)=>o.set(e.id,t+1));let s=e=>{switch(e.kind){case`linked`:{let t=o.get(e.targetId);return t===void 0?`→ ?`:`→ ${t}`}case`unresolved`:return`→ ${e.couplet}`;case`taxonDraft`:return i(e.name);case`taxon`:return`→ taxon`;case`empty`:return`<span class="import-preview-muted">(empty)</span>`}},c=e=>{let t=n.get(e);return!t||t.length===0?``:`<div class="import-preview-diagnostics warning-block">${t.map(e=>`<div class="${e.severity===`error`?`error-text`:`warning-text`}">${e.severity===`error`?`⛔`:`⚠️`} ${i(e.message)}</div>`).join(``)}</div>`};return t+=`<ol class="import-preview-list">`,e.couplets.forEach((e,r)=>{let a=n.has(e.id);t+=`
            ...
            </li>`}),t+=`</ol>`,t}async function Ar(e,t,n){if(!J||J.couplets.length===0||J.errors.length>0){I(`⚠️ There is nothing valid to import yet.`,`error`);return}let r=Y(`pt-import-title`)?.value.trim()||`Imported Key`;if(e.hasUnsavedChanges()&&!confirm(`You have unsaved changes in the current key. Importing will discard them. Continue?`))return;let i=e.getPersistedTitle();try{if((await A.getProjectList()).some(e=>e.name.toLowerCase()===r.toLowerCase())&&!confirm(`A local project named "${r}" already exists. Overwrite it with this import?`))return;let i={type:Ee,version:De,title:r,data:{title:r,key:J.couplets,figures:J.figures}},a=e.importJsonData(i);if(!a.success){alert(`Failed to import parsed key:\n• ${a.errors.join(`
• `)}`);return}e.setTitle(r),t.setActiveProjectTitle(r),await e.saveToStorage(),I(`📥 Imported "${r}" from plain text (${J.stepCount} step(s)).`,`success`),Dr(),n()}catch(n){console.error(`Plain text import failed:`,n),i&&(e.setTitle(i),t.setActiveProjectTitle(i)),A.clearStagedChanges(),I(`⚠️ The plain text import could not be completed.`,`error`)}}function jr(e,t,n,r){let i=Y(`pt-import-source`),a=Y(`pt-import-file-hidden`);i?.addEventListener(`input`,()=>{Cr=null,X()},{signal:r}),[`pt-opt-min-dots`,`pt-opt-ws`,`pt-opt-join`,`pt-opt-dehyphen`,`pt-opt-lettered`,`pt-opt-dash`,`pt-opt-backref`,`pt-opt-fill`].forEach(e=>{let t=Y(e);t?.addEventListener(`change`,()=>X(),{signal:r}),t?.addEventListener(`input`,()=>X(),{signal:r})}),Y(`pt-import-load-file`)?.addEventListener(`click`,()=>{a?.click()},{signal:r}),a?.addEventListener(`change`,async e=>{let t=e.target.files?.[0];if(t)try{let e=await t.arrayBuffer();Cr=e;let{text:n,encoding:r,autoDetected:a}=ur(e,Tr());i&&(i.value=n,X()),a&&I(`📥 Loaded "${t.name}" — detected ${sr(r)} encoding.`,`success`);let o=Y(`pt-import-title`);o&&!o.value.trim()&&(o.value=t.name.replace(/\.txt$/i,``).trim())}catch(e){console.error(`Failed to read plain text file:`,e),I(`⚠️ Could not read the selected file.`,`error`)}finally{e.target.value=``}},{signal:r}),Y(`pt-import-encoding`)?.addEventListener(`change`,()=>{if(!Cr)return;let{text:e}=ur(Cr,Tr());i&&(i.value=e,X())},{signal:r}),Y(`pt-import-clear`)?.addEventListener(`click`,()=>{i&&(i.value=``),Cr=null,X(),i?.focus()},{signal:r}),Y(`pt-import-close`)?.addEventListener(`click`,()=>Dr(),{signal:r}),Y(`pt-import-cancel`)?.addEventListener(`click`,()=>Dr(),{signal:r}),Y(`pt-import-confirm`)?.addEventListener(`click`,()=>{Ar(e,t,n)},{signal:r}),Y(Sr)?.addEventListener(`keydown`,e=>{e.key===`Escape`&&Or()&&(e.stopPropagation(),Dr())},{signal:r})}function Mr(e,t,n,r){let i=document.getElementById(`modal-shortcuts`),a=document.getElementById(`modal-options`),o=document.getElementById(`modal-about`),s=document.getElementById(`modal-open-project`),c=document.getElementById(`opt-lead-format`),l=document.getElementById(`opt-backref`),u=document.getElementById(`opt-name-display`),d=()=>{c?.querySelectorAll(`input[name="lead-format"]`).forEach(e=>{e.checked=e.value===t.leadFormat}),l&&(l.checked=t.showBackReference),u?.querySelectorAll(`input[name="name-display"]`).forEach(e=>{e.checked=e.value===t.nameDisplayMode})};c?.addEventListener(`change`,e=>{let r=e.target;r.name!==`lead-format`||!_(r.value)||(t.setLeadFormat(r.value),R(n))},{signal:r}),l?.addEventListener(`change`,()=>{t.setShowBackReference(l.checked),R(n)},{signal:r}),u?.addEventListener(`change`,e=>{let r=e.target;r.name!==`name-display`||!f(r.value)||(t.setNameDisplayMode(r.value),R(n))},{signal:r});let p=e=>{e.style.display=`flex`,e.querySelector(`button, input:not([disabled]), [tabindex]:not([tabindex="-1"])`)?.focus()};document.getElementById(`cmd-open-shortcuts`)?.addEventListener(`click`,()=>{p(i)},{signal:r}),document.getElementById(`cmd-open-options`)?.addEventListener(`click`,()=>{d(),p(a)},{signal:r}),document.getElementById(`cmd-open-about`)?.addEventListener(`click`,()=>{p(o)},{signal:r}),document.getElementById(`cmd-open-dialog`)?.addEventListener(`click`,async()=>{p(s),await Et(e)},{signal:r});let m=(e,t)=>{document.getElementById(t)?.addEventListener(`click`,()=>{e.style.display=`none`},{signal:r}),e.addEventListener(`click`,t=>{t.target===e&&(e.style.display=`none`)},{signal:r})};m(i,`modal-shortcuts-close`),m(a,`modal-options-close`),m(o,`modal-about-close`),m(s,`modal-project-close`),document.getElementById(`project-hub-list`)?.addEventListener(`click`,async t=>{let r=t.target,i=r.closest(`.hub-item-clickable-zone`),a=r.closest(`.btn-hub-delete`);if(i){let t=i.getAttribute(`data-name`);if(!t||e.hasUnsavedChanges()&&!confirm(`Your current key has unsaved tracking changes. Are you sure you want to discard them to switch workspaces?`))return;try{await e.loadProject(t),s.style.display=`none`,I(`📂 Swapped to workspace: "${t}"`,`success`),R(n)}catch(e){console.error(`Failed to load workspace safely:`,e),I(`⚠️ Could not open selected project database entries.`,`error`)}return}if(a){t.stopPropagation();let r=a.getAttribute(`data-name`);if(!r)return;let i=`Are you sure you want to permanently delete the workspace "${r}"?\nThis wipes it from your browser database.`;if(confirm(i))try{if(await A.deleteProject(r),I(`🗑️ Workspace "${r}" deleted.`,`success`),e.getPersistedTitle()===r){let t=await A.getProjectList();t.length>0?await e.loadProject(t[0].name):await e.createNewProject(`Untitled Key`)}await Et(e),R(n)}catch(e){console.error(`Failed to execute database deletion sequence:`,e),I(`⚠️ Failed to delete workspace from database.`,`error`)}}},{signal:r}),document.getElementById(`btn-hub-import`)?.addEventListener(`click`,()=>{document.querySelector(`#file-import-hidden`)?.click()},{signal:r})}var Nr=`
...
(function () {
  ...
  document.addEventListener('click', function (e) {
    ...
    open(img.getAttribute('src'), img.getAttribute('data-caption') || '');
...
})();`,Fr={text:i,fig:e=>`(Fig. ${e.displayNum})`,brokenFig:e=>`[Broken Fig: ${i(e.label)}]`,mark:Mt},Ir={...Fr,text:e=>i(e).replace(/\n/g,`<br>`)},Lr={text:e=>e,fig:e=>`(Fig. ${e.displayNum})`,brokenFig:e=>`[Broken Fig: ${e.label}]`,mark:(e,t)=>t};function Rr(e){let t=i(e.printText);switch(e.kind){case`taxon`:return`<strong class="print-dest-taxon">${t}</strong>`;case`step`:return`<strong class="print-dest-strong">${t}</strong>`;case`broken`:return`<span class="error-text">${t}</span>`;case`empty`:return`<span>${t}</span>`}}async function zr(e,t,n,r){try{let o=e.getActiveProjectUid(),s=Vt(e,{leadFormat:t,showBackReference:n,nameMode:r}),{title:c,taxa:l,figures:u}=s,d=(await Promise.all(u.map(async(e,t)=>{let n=t+1,r=``;try{let t=await A.getFigureBinary(o,e.id);if(t){let a=await ee(t),o=B(e.caption,Lr);r=`<img class="print-fig-img" src="${a}" alt="Figure ${n}" data-caption="${i(`Fig. ${n}${o?`: ${o}`:``}`)}" />`}}catch(t){console.warn(`Could not resolve binary payload stream for figure ID ${e.id}:`,t)}let a=e.caption?B(e.caption,Ir):i(e.filename||`Untitled Asset`);return`
                ...
                `}))).join(``),f=``,p=0;s.isEmpty&&(f=`<p class="print-empty-notice">[The identification key is currently empty. Add couplets in the editor to populate this document.]</p>`);for(let e of s.couplets){let t=Rr(e.dest1),n=Rr(e.dest2),r=z(e.alt1,Fr)||`___`,a=z(e.alt2,Fr)||`___`,{lead1:o,lead2:s}=e;p=Math.max(p,o.length,s.length),f+=`
            ...
            `}let m=``;if(l.length>0){let e=e=>i(e).replace(/\n/g,`<br>`),t=(e,t)=>`<p class="print-taxon-field"><strong>${e}:</strong> ${t}</p>`,n=e=>(e.isScientific?`<em>${i(e.name)}</em>`:i(e.name))+(e.auctor?` <span class="print-taxon-auctor">${i(e.auctor)}</span>`:``);m=`<h2 class="print-taxa-heading">Taxa</h2>${l.map(a=>{let o=Bt(a,r),s=`<div class="print-taxon"><h3 class="print-taxon-name">${n(o.heading)}</h3>`;if(o.secondary&&(s+=`<p class="print-taxon-field">${n(o.secondary)}</p>`),a.synonyms.length>0&&(s+=t(`Synonyms`,a.synonyms.map(e=>`<em>${i(e)}</em>`).join(`; `))),a.description&&(s+=t(`Description`,B(a.description,Ir,u))),a.biology&&(s+=t(`Biology`,e(a.biology))),a.distribution&&(s+=t(`Distribution`,e(a.distribution))),a.confusables.length>0){let e=a.confusables.map(e=>`<li><em>${i(e.name)}</em>${e.distinction?` — ${i(e.distinction)}`:``}</li>`).join(``);s+=`<div class="print-taxon-field"><strong>Confusable species:</strong><ul class="print-confusables">${e}</ul></div>`}return s+`</div>`}).join(``)}`}let h=u.length>0?` layout-has-figures`:``,g=`${Math.max(p,3)}ch`;a(Br(c,f,m,d,h,t,g),x(c,`.html`),`text/html;charset=utf-8;`)}catch(e){console.error(`HTML Export layout compilation system failure:`,e),I(`❌ An unexpected error disrupted the HTML file compilation pipeline.`,`error`)}}function Br(e,t,n,r,a,o,s){let c=i(e);return`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
</html>`}function Z(e){return e?e.replace(/[\r\n]+/g,` `).replace(/\\/g,`___TSKEY_LATEX_BACKSLASH___`).replace(/([&%$#_{}])/g,`\\$1`).replace(/~/g,`\\textasciitilde{}`).replace(/\^/g,`\\textasciicircum{}`).replace(/</g,`\\textless{}`).replace(/>/g,`\\textgreater{}`).replace(/___TSKEY_LATEX_BACKSLASH___/g,`\\textbackslash{}`):``}function Vr(e,t){return`\\makebox[${t}][l]{\\textbf{${Z(e).replace(/—/g,`\\textemdash{}`)}}}`}var Hr={bold:e=>`\\textbf{${e}}`,italic:e=>`\\textit{${e}}`,subscript:e=>`\\textsubscript{${e}}`,superscript:e=>`\\textsuperscript{${e}}`},Ur={text:Z,fig:e=>` (Fig.~${e.displayNum})`,brokenFig:e=>`[Broken Fig: ${Z(e.label)}]`,mark:(e,t)=>(Hr[e]??(e=>e))(t)};function Wr(e,t,n,r){try{let i=Vt(e,{leadFormat:t,showBackReference:n,nameMode:r}),{title:o,taxa:s,figures:c}=i,l=n?`4.5em`:`2.5em`,u=``;if(i.isEmpty)u=`
\\begin{center}
  \\vspace*{2cm}
  \\textit{\\small [The identification key is currently empty. Please add key steps in the editor to populate this document.]}
\\end{center}`;else{let e=``,t=e=>{switch(e.kind){case`taxon`:return`\\mbox{\\textbf{\\textit{${Z(e.printText)}}}}`;case`step`:return`\\mbox{\\textbf{${Z(e.printText)}}}`;default:return`\\dots`}};i.couplets.forEach(n=>{let r=t(n.dest1),i=t(n.dest2),a=z(n.alt1,Ur),o=z(n.alt2,Ur),{lead1:s,lead2:c}=n;e+=`{\\interlinepenalty=10000
`,e+=`\\noindent\\hangindent=${l}\\hangafter=1${Vr(s,l)}${a}\\nobreak\\dotfill\\allowbreak\\hspace*{0pt}\\dotfill ${r}\\par\\nopagebreak\n`,e+=`\\noindent\\hangindent=${l}\\hangafter=1${Vr(c,l)}${o}\\nobreak\\dotfill\\allowbreak\\hspace*{0pt}\\dotfill ${i}\\par}\n`,e+=`\\vspace{0.6em}
...
`,c.forEach((e,t)=>{let n=t+1,r=e.caption?B(e.caption,Ur):Z(`Figure ${n}`);f+=`\\begin{figure}[htbp]
`,f+=`  \\centering
...
`}));let p=``;if(s.length>0){let e=``,t=(e,t)=>`\\noindent\\textbf{${e}:} ${Z(t)}\\par\n`,n=e=>(e.isScientific?`\\textit{${Z(e.name)}}`:Z(e.name))+(e.auctor?` {\\small ${Z(e.auctor)}}`:``);s.forEach(i=>{let a=Bt(i,r);e+=`\\subsection*{${n(a.heading)}}\n`,a.secondary&&(e+=`\\noindent ${n(a.secondary)}\\par\n`),i.synonyms.length>0&&(e+=t(`Synonyms`,i.synonyms.join(`; `))),i.description&&(e+=`\\noindent\\textbf{Description:} ${B(i.description,Ur,c)}\\par\n`),i.biology&&(e+=t(`Biology`,i.biology)),i.distribution&&(e+=t(`Distribution`,i.distribution)),i.confusables.length>0&&(e+=`\\noindent\\textbf{Confusable species:}\\par
`,e+=`\\begin{itemize}
`,i.confusables.forEach(t=>{let n=t.distinction?` --- ${Z(t.distinction)}`:``;e+=`  \\item ${Z(t.name)}${n}\n`}),e+=`\\end{itemize}
`),e+=`\\vspace{0.8em}
...
${p}
${f}
\\end{document}`,x(o,`.tex`),`application/x-latex;charset=utf-8;`),d.length>0&&I(`⚠️ ${d.length} image filename(s) contain spaces, multiple dots, or LaTeX-special characters ({ } % # \\) and may fail to compile. Rename the image file(s) to match: ${d.join(`, `)}`,`error`)}catch(e){console.error(`LaTeX Export system failure:`,e),I(`❌ An unexpected error disrupted the LaTeX document generation pipeline.`,`error`)}}var Gr={text:e=>e,fig:e=>`(Fig. ${e.displayNum})`,brokenFig:e=>`[Broken Fig: ${e.label}]`,mark:(e,t)=>t};function Kr(e,t,n,r){try{let i=Vt(e,{leadFormat:t,showBackReference:n,nameMode:r}),{taxa:o,figures:s}=i,c=``;if(c+=`${i.title}\n\n`,i.isEmpty&&(c+=`[The identification key is currently empty. Add key steps in the editor to populate this document.]

`),i.couplets.forEach(e=>{let t=z(e.alt1,Gr)||`___`,n=z(e.alt2,Gr)||`___`;c+=`${e.lead1}\t${t}\t${e.dest1.printText}\n`,c+=`${e.lead2}\t${n}\t${e.dest2.printText}\n\n`}),o.length>0){c+=`========================================
`,c+=`TAXA
`,c+=`========================================

`;let e=e=>e.auctor?`${e.name} ${e.auctor}`:e.name;o.forEach((t,n)=>{let i=n+1,a=Bt(t,r);c+=`${i}. ${e(a.heading)}\n`,a.secondary&&(c+=`  ${a.secondary.label}: ${e(a.secondary)}\n`),t.synonyms.length>0&&(c+=`  Synonyms: ${t.synonyms.join(`; `)}\n`),t.description&&(c+=`  Description: ${B(t.description,Gr,s)}\n`),t.biology&&(c+=`  Biology: ${t.biology}\n`),t.distribution&&(c+=`  Distribution: ${t.distribution}\n`),t.confusables.length>0&&(c+=`  Confusable species:
`,t.confusables.forEach(e=>{c+=`    - ${e.name}${e.distinction?` — ${e.distinction}`:``}\n`})),c+=`
`})}s.length>0&&(c+=`========================================
`,c+=`FIGURES DATA
`,c+=`========================================

`,s.forEach((e,t)=>{let n=t+1,r=e.filename||`Untitled File`,i=e.caption?B(e.caption,Gr):`No caption provided.`;c+=`Figure #${n}\n`,c+=`  Filename: ${r}\n`,c+=`  Caption:  ${i}\n\n`})),a(c,x(i.title,`.txt`),`text/plain;charset=utf-8;`)}catch(e){console.error(`Plain Text Export system failure:`,e),I(`❌ An unexpected error disrupted the plain text document generation pipeline.`,`error`)}}async function qr(e){try{let t=e.getFigures(),n=[],r=e.getActiveProjectUid();for(let e of t){let t=await A.getFigureBinary(r,e.id),i=null;t&&(i=await ee(t)),n.push({...e,binaryData:i})}let i={metadata:{application:Ee,version:De,exportedAt:new Date().toISOString()},title:e.getTitle(),data:{title:e.getTitle(),key:e.getKey(),figures:n,taxa:e.getTaxa()}};a(JSON.stringify(i,null,2),x(e.getTitle(),`.tskey`),`application/json`)}catch(e){console.error(`JSON (.tskey) export system failure:`,e),I(`❌ An unexpected error disrupted the .tskey file export.`,`error`)}}function Jr(e,t,n,r){let i=document.getElementById(`modal-open-project`);document.querySelector(`#cmd-new`)?.addEventListener(`click`,async()=>{if(e.hasUnsavedChanges()&&!confirm(`You have unsaved workspace changes. Discard and make a brand new project memory space?`))return;let t=prompt(`Enter name/title for the new key:`,`Untitled Key`);if(t===null)return;let r=t.trim()||`Untitled Key`;try{if((await A.getProjectList()).some(e=>e.name.toLowerCase()===r.toLowerCase())&&!confirm(`A project named "${r}" already exists. Do you want to wipe it out and start fresh?`))return;await e.createNewProject(r),I(`📄 New workspace "${r}" initiated!`,`success`),R(n)}catch(e){console.error(`Failed to initialize a new project workspace safely: `,e),I(`⚠️ Could not initialize database workspace entries.`,`error`)}},{signal:r}),document.querySelector(`#cmd-save-as`)?.addEventListener(`click`,async()=>{let t=e.getTitle(),r=prompt(`Save current configuration under a new title:`,t);if(r===null)return;let i=r.trim();if(!i){I(`⚠️ Invalid project title.`,`error`);return}try{if((await A.getProjectList()).some(e=>e.name.toLowerCase()===i.toLowerCase())&&!confirm(`A project named "${i}" already exists. Do you want to overwrite it?`))return;await e.saveAsProject(i),I(`💾 Saved workspace as "${i}"`,`success`),R(n)}catch{I(`⚠️ Save As operation failed.`,`error`)}},{signal:r}),document.querySelector(`#cmd-save`)?.addEventListener(`click`,async()=>{let t=e.getPersistedTitle(),r=e.getTitle();try{if(t&&t!==r&&(await A.getProjectList()).some(e=>e.name.toLowerCase()===r.toLowerCase())&&!confirm(`A project named "${r}" already exists. Overwrite it?`))return;await e.saveToStorage(),I(t&&t!==r?`💾 Renamed and saved workspace as "${r}"`:`💾 Changes saved successfully!`,`success`),R(n)}catch(n){console.error(`Atomic save/rename failed:`,n),t&&t!==r&&e.setTitle(t),I(`⚠️ Save failed. Your changes were kept in memory.`,`error`)}},{signal:r}),document.querySelector(`#cmd-export-json`)?.addEventListener(`click`,()=>{qr(e)},{signal:r});let a=document.querySelector(`#file-import-hidden`),o=!1;a?.addEventListener(`change`,async t=>{let r=t.target.files?.[0];if(!r)return;if(o){I(`⚠️ An import is currently in progress. Please wait.`,`error`),a&&(a.value=``);return}if(e.hasUnsavedChanges()&&!confirm(`You have unsaved changes in the current key. Importing will discard them. Continue?`)){a&&(a.value=``);return}let s=e.getPersistedTitle();try{o=!0;let t=await r.text(),s=JSON.parse(t),c=`Untitled Imported Key`;if(s&&typeof s.title==`string`&&s.title.trim()?c=s.title.trim():r.name&&(c=r.name.replace(/\.tskey$/i,``).trim()),(await A.getProjectList()).some(e=>e.name.toLowerCase()===c.toLowerCase())&&!confirm(`A local project named "${c}" already exists. Do you want to completely overwrite it with this import file?`)){a&&(a.value=``);return}let l=e.importJsonData(s);if(!l.success){alert(`Failed to import JSON schema:\n• ${l.errors.join(`
• `)}`),a&&(a.value=``);return}e.setTitle(c);let u=[];if(l.importedFigures&&l.importedFigures.length>0){for(let e of l.importedFigures)if(e.binaryData)try{let t=await(await fetch(e.binaryData)).blob();A.uploadFigureBinary(e.id,t);let n=j.get(e.id);n&&URL.revokeObjectURL(n);let r=URL.createObjectURL(t);j.set(e.id,r)}catch(t){console.error(`Failed to parse binary data for figure ${e.id}:`,t),u.push(e.id)}}await e.saveToStorage(),u.length===0?I(`📥 Imported workspace "${c}" successfully!`,`success`):(I(`⚠️ Workspace imported, but ${u.length} image(s) failed.`,`error`),alert(`Workspace "${c}" was loaded, but the following figure IDs encountered binary errors or corruption and could not be recovered:\n\n• Figure ID(s): ${u.join(`, `)}\n\nPlease try re-uploading these specific images in the editor.`)),i&&i.style.display===`flex`&&await Et(e),R(n)}catch(t){console.error(`Import processing error:`,t),s&&e.setTitle(s),A.clearStagedChanges(),alert(`Malformed JSON structure: Unable to parse file stream.`)}finally{o=!1,a&&(a.value=``)}},{signal:r}),document.querySelector(`#cmd-trigger-import`)?.addEventListener(`click`,()=>{if(o){I(`⚠️ An import is currently in progress. Please wait.`,`error`);return}a?.click()},{signal:r}),document.querySelector(`#cmd-import-text`)?.addEventListener(`click`,()=>{if(o){I(`⚠️ An import is currently in progress. Please wait.`,`error`);return}Er()},{signal:r}),document.querySelector(`#cmd-export-text`)?.addEventListener(`click`,()=>Kr(e,t.leadFormat,t.showBackReference,t.nameDisplayMode),{signal:r}),document.querySelector(`#cmd-export-html`)?.addEventListener(`click`,()=>zr(e,t.leadFormat,t.showBackReference,t.nameDisplayMode),{signal:r}),document.querySelector(`#cmd-export-latex`)?.addEventListener(`click`,()=>Wr(e,t.leadFormat,t.showBackReference,t.nameDisplayMode),{signal:r})}function Yr(e,t,n,r){document.querySelector(`#cmd-undo`)?.addEventListener(`click`,()=>{t.typing.clearAll(),e.undo()&&R(n)},{signal:r}),document.querySelector(`#cmd-redo`)?.addEventListener(`click`,()=>{t.typing.clearAll(),e.redo()&&R(n)},{signal:r}),document.querySelector(`#cmd-cut`)?.addEventListener(`click`,()=>{let t=e.getSelectedCoupletIds().size;t>0&&confirm(`Confirm cutting ${t} highlighted step(s) to clipboard?`)&&(e.cutSelectedCouplets(),I(`Cut ${t} step(s) to clipboard.`,`success`),R(n))},{signal:r}),document.querySelector(`#cmd-copy`)?.addEventListener(`click`,()=>{let t=e.getSelectedCoupletIds().size;t>0&&(e.copySelectedCouplets(),I(`Copied ${t} step(s) to clipboard.`,`success`),R(n))},{signal:r}),document.querySelector(`#cmd-paste-above`)?.addEventListener(`click`,()=>{on(e,n,`above`)},{signal:r}),document.querySelector(`#cmd-paste-below`)?.addEventListener(`click`,()=>{on(e,n,`below`)},{signal:r}),document.querySelector(`#cmd-delete`)?.addEventListener(`click`,()=>{let t=e.getSelectedCoupletIds().size,r=e.getSelectedFigureIds().size,i=e.getSelectedTaxonIds().size;if(i>0&&confirm(`Confirm removing highlighted taxa? Any key leads pointing at them will be cleared.`)&&(e.deleteSelectedTaxa(),I(`Deleted ${i} taxon(a).`,`success`),R(n)),t>0&&confirm(`Confirm removing highlighted key steps?`)&&(e.deleteSelectedCouplets(),I(`Deleted ${t} step(s).`,`success`),R(n)),r>0&&confirm(`Confirm removing highlighted figures?`)){let t=new Set(e.getSelectedFigureIds());e.deleteSelectedFigures(),t.forEach(e=>{A.deleteFigureBinary(e);let t=j.get(e);t&&URL.revokeObjectURL(t),j.delete(e)}),I(`Deleted ${r} figure(s).`,`success`),R(n)}},{signal:r}),document.querySelector(`#cmd-swap`)?.addEventListener(`click`,()=>{e.getSelectedCoupletIds().size>0&&e.swapSelectedCouplets()&&(I(`Swapped choice configurations.`,`success`),R(n))},{signal:r});let i=()=>an(e,n);document.querySelector(`#cmd-add`)?.addEventListener(`click`,i,{signal:r}),document.querySelector(`#add-couplet-btn`)?.addEventListener(`click`,i,{signal:r}),document.querySelector(`#cmd-clear`)?.addEventListener(`click`,()=>{e.clearSelection(),e.clearFigureSelection(),e.clearTaxonSelection(),R(n)},{signal:r}),document.querySelector(`#cmd-select-all`)?.addEventListener(`click`,()=>{e.selectAll(),R(n)},{signal:r}),document.querySelector(`#cmd-toggle-figures`)?.addEventListener(`click`,()=>{t.toggleFigures(),R(n)},{signal:r}),document.querySelector(`#cmd-toggle-images`)?.addEventListener(`click`,()=>{t.toggleImages(),R(n)},{signal:r}),document.querySelector(`#cmd-toggle-taxa`)?.addEventListener(`click`,()=>{t.toggleTaxa(),R(n)},{signal:r}),document.querySelector(`#cmd-toggle-print`)?.addEventListener(`click`,()=>{t.togglePrint(),R(n)},{signal:r}),document.querySelector(`#cmd-reorder-couplets`)?.addEventListener(`click`,()=>{e.autoOrderCouplets(),I(`Key steps reordered with shorter branches first!`,`success`),R(n)},{signal:r}),document.querySelector(`#cmd-reorder-figures`)?.addEventListener(`click`,()=>{e.autoOrderFigures(),I(`Figures reordered to match key reference order!`,`success`),R(n)},{signal:r})}function Xr(e,t,n){let r=document.querySelector(`.main-layout`);r&&r.addEventListener(`click`,n=>{let r=n.target.closest(`.panel-toggle`);if(!r)return;let i=r.closest(`[data-panel]`)?.dataset.panel;i&&(e.togglePanelCollapse(i),R(t))},{signal:n})}function Zr(e){let t=document.querySelector(`.app-menu-bar`);if(!t)return;let n=()=>Array.from(t.querySelectorAll(`.menu-trigger`)),r=e=>{let t=e.nextElementSibling;return t?Array.from(t.querySelectorAll(`.dropdown-action:not(:disabled)`)):[]},i=()=>{n().forEach(e=>e.setAttribute(`aria-expanded`,`false`))};t.addEventListener(`click`,e=>{let t=e.target.closest(`.menu-trigger`);if(t){e.stopPropagation();let n=t.getAttribute(`aria-expanded`)===`true`;i(),t.setAttribute(`aria-expanded`,n?`false`:`true`)}},{signal:e}),t.addEventListener(`pointerover`,e=>{let t=e.target.closest(`.menu-trigger`);!t||t.getAttribute(`aria-expanded`)===`true`||n().some(e=>e.getAttribute(`aria-expanded`)===`true`)&&(i(),t.setAttribute(`aria-expanded`,`true`))},{signal:e}),document.addEventListener(`click`,()=>i(),{signal:e}),t.addEventListener(`keydown`,e=>{let t=document.activeElement;if(!t)return;let a=t.classList.contains(`menu-trigger`),o=t.classList.contains(`dropdown-action`);if(!a&&!o)return;let s=n(),c=a?t:t.closest(`.menu-item`)?.querySelector(`.menu-trigger`),l=r(c),u=s.indexOf(c),d=l.indexOf(t);switch(e.key){case`ArrowRight`:{if(e.preventDefault(),s.length===0)return;let t=s[(u+1)%s.length],n=c?.getAttribute(`aria-expanded`)===`true`;i(),t.focus(),n&&t.setAttribute(`aria-expanded`,`true`);break}case`ArrowLeft`:{if(e.preventDefault(),s.length===0)return;let t=s[(u-1+s.length)%s.length],n=c?.getAttribute(`aria-expanded`)===`true`;i(),t.focus(),n&&t.setAttribute(`aria-expanded`,`true`);break}case`ArrowDown`:e.preventDefault(),a&&c?(c.setAttribute(`aria-expanded`,`true`),l.length>0&&l[0].focus()):o&&l.length>0&&l[(d+1)%l.length].focus();break;case`ArrowUp`:e.preventDefault(),o&&l.length>0&&l[(d-1+l.length)%l.length].focus();break;case`Escape`:e.preventDefault(),i(),c?.focus();break;case`Enter`:case` `:if(a&&c){e.preventDefault();let t=c.getAttribute(`aria-expanded`)===`true`;c.setAttribute(`aria-expanded`,t?`false`:`true`),!t&&l.length>0&&setTimeout(()=>l[0].focus(),10)}break}},{signal:e})}function Qr(e,t){let n=new AbortController;return window.addEventListener(`keydown`,r=>{let i=document.getElementById(`plain-text-import-view`);if(i&&i.style.display===`flex`)return;let a=document.querySelectorAll(`.modal-overlay`),s=Array.from(a).find(e=>e.style.display===`flex`);if(s){if(r.key===`Escape`){s.style.display=`none`,r.preventDefault();return}if(r.key===`Tab`){r.preventDefault();let e=Array.from(s.querySelectorAll(`button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])`)).filter(e=>e.offsetParent!==null);e.length>0&&e[(e.indexOf(document.activeElement)+(r.shiftKey?-1:1)+e.length)%e.length].focus();return}}let c=o?r.metaKey:r.ctrlKey,l=document.activeElement,u=l&&(l.tagName===`INPUT`||l.tagName===`TEXTAREA`||l.hasAttribute(`contenteditable`));if(r.altKey&&!c&&!r.shiftKey&&r.code===`KeyF`&&kn(l)){r.preventDefault();let t=l.getBoundingClientRect();jn(e,t.left+16,t.top+24,n.signal);return}if(c&&r.key.toLowerCase()===`s`){r.preventDefault(),r.shiftKey?document.querySelector(`#cmd-save-as`)?.click():document.querySelector(`#cmd-save`)?.click();return}if(c&&r.key.toLowerCase()===`o`){r.preventDefault(),document.querySelector(`#cmd-open-dialog`)?.click();return}if(c&&r.altKey&&r.key.toLowerCase()===`n`){r.preventDefault(),document.querySelector(`#cmd-new`)?.click();return}if(c&&r.shiftKey&&r.key.toLowerCase()===`f`){r.preventDefault(),document.querySelector(`#cmd-toggle-figures`)?.click();return}if(c&&r.shiftKey&&r.key.toLowerCase()===`p`){r.preventDefault(),document.querySelector(`#cmd-toggle-print`)?.click();return}if(!u){if(r.altKey&&r.key.toLowerCase()===`n`){r.preventDefault(),document.querySelector(`#cmd-add`)?.click();return}if(c&&r.key.toLowerCase()===`a`){r.preventDefault(),document.querySelector(`#cmd-select-all`)?.click();return}if(r.altKey&&r.key.toLowerCase()===`s`){r.preventDefault(),document.querySelector(`#cmd-swap`)?.click();return}if(c&&r.key.toLowerCase()===`z`){r.preventDefault(),r.shiftKey?document.querySelector(`#cmd-redo`)?.click():document.querySelector(`#cmd-undo`)?.click();return}if(c&&r.key.toLowerCase()===`y`){r.preventDefault(),document.querySelector(`#cmd-redo`)?.click();return}if(r.key===`Delete`||r.key===`Backspace`){r.preventDefault(),document.querySelector(`#cmd-delete`)?.click();return}if(r.key===`Escape`){r.preventDefault(),document.querySelector(`#cmd-clear`)?.click();return}let n=(window.getSelection()?.toString()??``).trim()!==``;if(c&&r.key.toLowerCase()===`c`){if(n||e.getSelectedCoupletIds().size===0)return;r.preventDefault(),document.querySelector(`#cmd-copy`)?.click();return}if(c&&r.key.toLowerCase()===`x`){if(n||e.getSelectedCoupletIds().size===0)return;r.preventDefault(),document.querySelector(`#cmd-cut`)?.click();return}if(c&&r.key.toLowerCase()===`v`){if(!e.hasClipboardData())return;r.preventDefault(),on(e,t,r.shiftKey?`above`:`below`);return}}},{signal:n.signal}),()=>{n.abort()}}var $r=[{mark:`bold`,title:`Bold (Ctrl/Cmd+B)`,html:`<b>B</b>`},{mark:`italic`,title:`Italic (Ctrl/Cmd+I)`,html:`<i>I</i>`},{mark:`subscript`,title:`Subscript`,html:`x<sub>2</sub>`},{mark:`superscript`,title:`Superscript`,html:`x<sup>2</sup>`}],ei=new Map(pt.map(e=>[e.tag.toUpperCase(),e.name]));function ti(e){let t=new Set,n=window.getSelection();if(!n||n.rangeCount===0)return t;let r=n.getRangeAt(0).commonAncestorContainer;for(;r&&r!==e;){if(r.nodeType===Node.ELEMENT_NODE){let e=r;if(e.dataset.open!==void 0){let n=ei.get(e.tagName);n&&t.add(n)}}r=r.parentNode}return t}var Q=null,ni=null,$=null,ri=null,ii=null;function ai(e){return e?(e.nodeType===Node.ELEMENT_NODE?e:e.parentElement)?.closest(`.rte-host`)??null:null}function oi(){let e=window.getSelection();if(!e||e.rangeCount===0||e.isCollapsed)return null;let t=ai(e.anchorNode);return!t||t!==ai(e.focusNode)?null:t}function si(){let e=document.createElement(`div`);return e.className=`format-toolbar`,e.setAttribute(`role`,`toolbar`),e.style.display=`none`,e.innerHTML=$r.map(e=>`<button type="button" data-mark="${e.mark}" title="${e.title}" aria-pressed="false">${e.html}</button>`).join(``)+`<button type="button" data-fig title="Insert figure reference (Alt+F)">Fig</button>`,e.addEventListener(`mousedown`,e=>e.preventDefault()),e.addEventListener(`click`,t=>{let n=t.target.closest(`button`);if(!n||!ni)return;let r=n.getAttribute(`data-mark`);if(r)gt(ni)?.toggleMark(r);else if(n.hasAttribute(`data-fig`)&&ri&&ii){let t=e.getBoundingClientRect();jn(ri,t.left,t.bottom+4,ii)}}),e}function ci(){Q&&(Q.style.display=`none`),ni=null}function li(){$=null;let e=oi();if(!e){ci();return}ni=e,Q||(Q=si(),document.body.appendChild(Q));let t=Q.querySelector(`[data-fig]`);t.style.display=e.dataset.rteFigures===`true`?``:`none`;let n=ti(e);Q.querySelectorAll(`[data-mark]`).forEach(e=>{let t=n.has(e.getAttribute(`data-mark`));e.classList.toggle(`is-active`,t),e.setAttribute(`aria-pressed`,t?`true`:`false`)}),Q.style.display=`flex`,Q.style.visibility=`hidden`;let r=window.getSelection().getRangeAt(0).getBoundingClientRect(),i=Q.getBoundingClientRect(),a=r.top-i.height-8;a<4&&(a=r.bottom+8);let o=r.left+r.width/2-i.width/2;o=Math.max(8,Math.min(o,window.innerWidth-i.width-8)),Q.style.top=`${a}px`,Q.style.left=`${o}px`,Q.style.visibility=`visible`}function ui(){$===null&&($=requestAnimationFrame(li))}function di(e,t){ri=e,ii=t,document.addEventListener(`selectionchange`,ui,{signal:t}),window.addEventListener(`scroll`,ui,{signal:t,capture:!0}),window.addEventListener(`resize`,ui,{signal:t}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&ci()},{signal:t}),t.addEventListener(`abort`,()=>{$!==null&&cancelAnimationFrame($),$=null,Q?.remove(),Q=null,ni=null,ri=null,ii=null})}var fi=[{id:101,alt1:`Has feathers [figID: 101]`,alt2:`Lacks feathers`,branch1:{kind:`taxonDraft`,name:`Bird`},branch2:{kind:`linked`,targetId:102}},{id:102,alt1:`Has fur [figID: 102]`,alt2:`Scales or bare skin`,branch1:{kind:`taxonDraft`,name:`Mammal`},branch2:{kind:`linked`,targetId:103}},{id:103,alt1:`Has scales [figID: 103]`,alt2:`Skin is smooth and moist`,branch1:{kind:`taxonDraft`,name:`Reptile2`},branch2:{kind:`taxonDraft`,name:`Amphibian`}}],pi=[{id:101,filename:`feathers.jpg`,caption:`Bird feathers`},{id:102,filename:`fur.jpg`,caption:`Wolf fur`},{id:103,filename:`Lizard.jpg`,caption:`Lizard scales`}];function mi(e,t,n){let r=document.querySelector(`#editor-container`);if(!r)return()=>{};let i=new AbortController,{signal:a}=i;return jr(e,t,n,a),Zt(e,n,a),en(r,e,n,a),tn(r,e,t,n,a),nn(r,e,t,n,a),rn(r,e,n,a),Mn(e,t,n,a),Wn(e,t,n,a),Mr(e,t,n,a),Jr(e,t,n,a),Yr(e,t,n,a),Pn(e,a),di(e,a),Jt(e,t,a),Yt(e,n,a),Zr(a),Xr(t,n,a),()=>{i.abort()}}async function hi(){let e=document.querySelector(`#app`);if(!e)throw Error(`Application bootstrap failed: DOM target element '#app' was not found.`);let t=new Le,n=t.activeProjectTitle,r=new Me([],[]);r.setProjectPersistedListener(e=>t.setActiveProjectTitle(e));let i=!1;if(n&&n!==`Untitled Key`)try{i=await r.loadProject(n)}catch(e){console.error(`Failed to restore active project session "${n}":`,e)}i||(console.log(`🌱 No active database workspace recovered. Hydrating baseline sample template.`),await r.loadFromStorage([...fi],[...pi],`Untitled Key`),t.setActiveProjectTitle(`Untitled Key`));let a=()=>{ze(t),Ve(r,t),fn(r,t,a),ar(r,t),Ln(r,t,a),$n(r,t,a)},o=[],s=e=>{r.hasUnsavedChanges()&&(e.preventDefault(),e.returnValue=``)};window.addEventListener(`beforeunload`,s),o.push(()=>window.removeEventListener(`beforeunload`,s)),Re(e);let c=mi(r,t,a),l=Qr(r,a);o.push(c),o.push(l),a()}hi();