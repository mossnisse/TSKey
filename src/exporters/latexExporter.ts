 ...
 */
export function exportKeyToLaTeX(store: KeyStore, leadFormat: LeadFormat, showBackReference: boolean, nameMode: NameDisplayMode): ExportWarnings {
...
\\end{document}`;
    ...
    // The caller decides how to surface this; a hostile filename still exports, it
    // just may not compile until the image is renamed.
    return problematicFilenames.length > 0
